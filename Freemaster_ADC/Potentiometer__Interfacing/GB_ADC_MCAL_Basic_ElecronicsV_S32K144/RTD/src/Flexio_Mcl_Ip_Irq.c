...
#define FLEXIO_MCL_IP_IRQ_SW_MAJOR_VERSION_C               1
...
#if (FLEXIO_MCL_IP_IRQ_VENDOR_ID_C != FLEXIO_MCL_IP_VENDOR_ID_H)
...
#if ((FLEXIO_MCL_IP_IRQ_AR_RELEASE_MAJOR_VERSION_C != FLEXIO_MCL_IP_AR_RELEASE_MAJOR_VERSION_H) || \
     (FLEXIO_MCL_IP_IRQ_AR_RELEASE_MINOR_VERSION_C != FLEXIO_MCL_IP_AR_RELEASE_MINOR_VERSION_H) || \
     (FLEXIO_MCL_IP_IRQ_AR_RELEASE_REVISION_VERSION_C != FLEXIO_MCL_IP_AR_RELEASE_REVISION_VERSION_H) \
    )
...
#if ((FLEXIO_MCL_IP_IRQ_SW_MAJOR_VERSION_C != FLEXIO_MCL_IP_SW_MAJOR_VERSION_H) || \
     (FLEXIO_MCL_IP_IRQ_SW_MINOR_VERSION_C != FLEXIO_MCL_IP_SW_MINOR_VERSION_H) || \
     (FLEXIO_MCL_IP_IRQ_SW_PATCH_VERSION_C != FLEXIO_MCL_IP_SW_PATCH_VERSION_H) \
    )
...
#if (FLEXIO_MCL_IP_IRQ_VENDOR_ID_C != FLEXIO_MCL_IP_CFG_DEVICEREGISTERS_VENDOR_ID_H)
...
#if ((FLEXIO_MCL_IP_IRQ_AR_RELEASE_MAJOR_VERSION_C != FLEXIO_MCL_IP_CFG_DEVICEREGISTERS_AR_RELEASE_MAJOR_VERSION_H) || \
     (FLEXIO_MCL_IP_IRQ_AR_RELEASE_MINOR_VERSION_C != FLEXIO_MCL_IP_CFG_DEVICEREGISTERS_AR_RELEASE_MINOR_VERSION_H) || \
     (FLEXIO_MCL_IP_IRQ_AR_RELEASE_REVISION_VERSION_C != FLEXIO_MCL_IP_CFG_DEVICEREGISTERS_AR_RELEASE_REVISION_VERSION_H) \
    )
...
#if ((FLEXIO_MCL_IP_IRQ_SW_MAJOR_VERSION_C != FLEXIO_MCL_IP_CFG_DEVICEREGISTERS_SW_MAJOR_VERSION_H) || \
     (FLEXIO_MCL_IP_IRQ_SW_MINOR_VERSION_C != FLEXIO_MCL_IP_CFG_DEVICEREGISTERS_SW_MINOR_VERSION_H) || \
     (FLEXIO_MCL_IP_IRQ_SW_PATCH_VERSION_C != FLEXIO_MCL_IP_CFG_DEVICEREGISTERS_SW_PATCH_VERSION_H) \
    )
...
#endif /* #if (defined(FLEXIO_PWM_IP_HAS_PIN_OVERRIDE) && (FLEXIO_PWM_IP_HAS_PIN_OVERRIDE == STD_ON)) */
#endif
#ifdef USE_UART_MODULE
...
static void Flexio_Mcl_Ip_CommonIrq(void)
{
...
#if defined(USE_UART_MODULE) || defined(USE_I2C_MODULE) || defined(USE_PWM_MODULE) || defined(USE_SENT_MODULE)
...
#endif
#endif /* FLEXIO_MCL_IP_PIN_STS_IS_AVAILABLE == STD_ON */
    ...
    #if defined(UART_CHANNEL_0_USED) || defined(I2C_CHANNEL_0_USED)
    ...
    #endif /* if defined(UART_CHANNEL_0_USED) || defined(I2C_CHANNEL_0_USED) */
#endif /*ifdef FLEXIO_0_CH_0_USED*/

#ifdef FLEXIO_0_CH_1_USED
    #if defined(UART_CHANNEL_1_USED) || defined(I2C_CHANNEL_1_USED)
    ...
    #endif /*if defined(UART_CHANNEL_1_USED) || defined(I2C_CHANNEL_1_USED) */
#endif /*ifdef FLEXIO_0_CH_1_USED*/

#ifdef FLEXIO_0_CH_2_USED
    #if defined(UART_CHANNEL_2_USED) || defined(I2C_CHANNEL_2_USED)
    ...
    #endif /*if defined(UART_CHANNEL_2_USED) || defined(I2C_CHANNEL_2_USED) */
#endif /*ifdef FLEXIO_0_CH_2_USED*/

#ifdef FLEXIO_0_CH_3_USED
    #if defined(UART_CHANNEL_3_USED) || defined(I2C_CHANNEL_3_USED)
    ...
    #endif /* defined(UART_CHANNEL_3_USED) || defined(I2C_CHANNEL_3_USED) */
#endif /*ifdef FLEXIO_0_CH_3_USED*/

#ifdef FLEXIO_0_CH_4_USED
    #if defined(UART_CHANNEL_4_USED) || defined(I2C_CHANNEL_4_USED)
    ...
    #endif /*if defined(UART_CHANNEL_4_USED) || defined(I2C_CHANNEL_4_USED) */
#endif /*ifdef FLEXIO_0_CH_4_USED*/

#ifdef FLEXIO_0_CH_5_USED
    #if defined(UART_CHANNEL_5_USED) || defined(I2C_CHANNEL_5_USED)
    ...
    #endif /*if defined(UART_CHANNEL_5_USED) || defined(I2C_CHANNEL_5_USED) */
#endif /*ifdef FLEXIO_0_CH_5_USED*/

#ifdef FLEXIO_0_CH_6_USED
    #if defined(UART_CHANNEL_6_USED) || defined(I2C_CHANNEL_6_USED)
    ...
    #endif /*if defined(UART_CHANNEL_6_USED) || defined(I2C_CHANNEL_6_USED) */
#endif /*ifdef FLEXIO_0_CH_6_USED*/

#ifdef FLEXIO_0_CH_7_USED
    #if defined(UART_CHANNEL_7_USED) || defined(I2C_CHANNEL_7_USED)
    ...
    #endif /*if defined(UART_CHANNEL_7_USED) || defined(I2C_CHANNEL_7_USED) */
