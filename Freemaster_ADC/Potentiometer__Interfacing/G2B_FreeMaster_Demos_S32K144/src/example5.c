...
void IoHwAb_AdcNotification_0( void )
{
    ...
    StdReturn = Adc_ReadGroup(AdcGroup_5_HW_WI_OS_PDB_B2B, Result);
...
int main(void)
{
    ...
    /*******************************************************************************************************/
        ...
        Adc_SetupResultBuffer( AdcGroup_5_HW_WI_OS_PDB_B2B, ResultBuffer );

        Adc_EnableGroupNotification(AdcGroup_5_HW_WI_OS_PDB_B2B);
...
//       while( Adc_GetGroupStatus( AdcGroup_5_HW_WI_OS_PDB_B2B ) == ADC_BUSY );
    	...
    	Adc_DisableHardwareTrigger(AdcGroup_5_HW_WI_OS_PDB_B2B);
