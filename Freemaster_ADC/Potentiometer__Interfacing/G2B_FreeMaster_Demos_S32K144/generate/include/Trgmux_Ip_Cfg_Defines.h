...
==================================================================================================*/
#define TRGMUX_IP_CFG_DEFINES_VENDOR_ID_H                    43
#define TRGMUX_IP_CFG_DEFINES_MODULE_ID_H                    255
#define TRGMUX_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION_H     4
#define TRGMUX_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION_H     4
#define TRGMUX_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION_H  0
#define TRGMUX_IP_CFG_DEFINES_SW_MAJOR_VERSION_H             1
#define TRGMUX_IP_CFG_DEFINES_SW_MINOR_VERSION_H             0
#define TRGMUX_IP_CFG_DEFINES_SW_PATCH_VERSION_H             0
...
#if ((TRGMUX_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION_H != STD_AR_RELEASE_MAJOR_VERSION) || \
     (TRGMUX_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION_H != STD_AR_RELEASE_MINOR_VERSION))
