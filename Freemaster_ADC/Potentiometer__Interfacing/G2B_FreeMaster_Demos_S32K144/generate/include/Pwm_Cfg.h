...
#include "Pwm_BOARD_InitPeripherals_PBcfg.h"
...
/* Check if header file and PWM configuration header file are of the same vendor */
#if (PWM_CFG_VENDOR_ID != PWM_BOARD_InitPeripherals_PB_CFG_VENDOR_ID)
    #error "Pwm_Cfg.h and Pwm_BOARD_InitPeripherals_PBcfg.h have different vendor IDs"
#endif
    /* Check if header file and Pwm configuration header file are of the same Autosar version */
#if ((PWM_CFG_AR_RELEASE_MAJOR_VERSION != PWM_BOARD_InitPeripherals_PB_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (PWM_CFG_AR_RELEASE_MINOR_VERSION != PWM_BOARD_InitPeripherals_PB_CFG_AR_RELEASE_MINOR_VERSION) || \
     (PWM_CFG_AR_RELEASE_REVISION_VERSION != PWM_BOARD_InitPeripherals_PB_CFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Pwm_Cfg.h and Pwm_BOARD_InitPeripherals_PBcfg.h are different"
#endif
/* Check if header file and Pwm configuration header file are of the same software version */
#if ((PWM_CFG_SW_MAJOR_VERSION != PWM_BOARD_InitPeripherals_PB_CFG_SW_MAJOR_VERSION) || \
     (PWM_CFG_SW_MINOR_VERSION != PWM_BOARD_InitPeripherals_PB_CFG_SW_MINOR_VERSION) || \
     (PWM_CFG_SW_PATCH_VERSION != PWM_BOARD_InitPeripherals_PB_CFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Pwm_Cfg.h and Pwm_BOARD_InitPeripherals_PBcfg.h are different"
#endif
...
#define PWM_CONFIG_EXTERNAL \
                PWM_CONFIG_BOARD_InitPeripherals_PB
