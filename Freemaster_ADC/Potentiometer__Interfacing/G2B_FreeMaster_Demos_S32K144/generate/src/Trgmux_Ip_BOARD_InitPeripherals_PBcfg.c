...
const Trgmux_Ip_LogicTriggerType Trgmux_Ip_LogicTrigger0ConfigPB_BOARD_INITPERIPHERALS =
{
...
const Trgmux_Ip_InitType Trgmux_Ip_xTrgmuxInitPB_BOARD_INITPERIPHERALS =
{
    /* Trgmux_Ip_LogicTriggerType * paxLogicTrigger[]; */
    {
		&Trgmux_Ip_LogicTrigger0ConfigPB_BOARD_INITPERIPHERALS,
    }
};
