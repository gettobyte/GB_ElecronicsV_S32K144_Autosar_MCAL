...
/*=============================================================================================*/
static uint8 Pwm_GetPartitionChannelIdx(uint32              coreId,
...
static inline void Pwm_EndValidateGlobalConfigCall(uint32           coreId,
     ...
     (PWM_SET_DUTY_PHASE_SHIFT_API          == STD_ON))
/*=============================================================================================*/
static Std_ReturnType Pwm_ValidateChannelConfigCall(uint32              coreId,
                                                    Pwm_ChannelType     channelNumber,
                                                    uint8               serviceId);
...
{
#if (PWM_MULTICORE_ENABLED == STD_ON)
    return (*(Pwm_aState[coreId].pwmConfig)->pPwmLogicalToPartitionMap)[channelNumber];
#else
                                                           ...
                                                           Pwm_EdgeNotificationType notification)
{
    ...
    Pwm_NotifyType                      pPwmChannelNotification;
    ...
    pPwmChannelNotification = (*Pwm_aState[coreId].pwmChannelConfigs)[channelNumber].pfPwmChannelNotification;
...
void Pwm_Notification(uint8 channel)
{
    ...
    if (NULL_PTR != Pwm_aState[coreId].pwmConfig)
    {
        ...
        pfNotify = (*Pwm_aState[coreId].pwmChannelConfigs)[partitionChannelIdx].pfPwmChannelNotification;
