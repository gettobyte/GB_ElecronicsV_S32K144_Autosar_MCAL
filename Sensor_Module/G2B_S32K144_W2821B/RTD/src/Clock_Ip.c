...
static void Clock_Ip_CallEmptyCallbacks(void)
{
    ...
    if (FALSE == FunctionWasCalled)
    {
        ...
        (void)Clock_Ip_GetConfiguredFrequencyValue(RESERVED_CLK);
#endif
    }
}
...
#if (defined(CLOCK_IP_SUPPORTS_WAIT_STATES) && (CLOCK_IP_SUPPORTS_WAIT_STATES == STD_ON))
...
static void Clock_Ip_SetWaitStates(void)
{
    ...
    if (Clock_Ip_driverContext.WaitStatesAreSupported)
    {
#if (defined(CLOCK_IP_DEV_ERROR_DETECT)) 
  #if (CLOCK_IP_DEV_ERROR_DETECT == STD_ON)
