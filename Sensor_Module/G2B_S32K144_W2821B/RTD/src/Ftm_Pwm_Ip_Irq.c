...
#define FTM_PWM_IP_IRQ_SW_PATCH_VERSION_C               1
...
==================================================================================================*/
#if ((defined FTM_PWM_IP_0_ISR_USED) || (defined FTM_PWM_IP_1_ISR_USED) \
...
static void Ftm_Pwm_Ip_ProcessCommonInterrupt(uint8 Instance, uint8 HwChannel)
{
    ...
    if (((uint8)0U != ChieStatus) && ((uint8)0U != ChfStatus) && (FTM_PWM_IP_NO_EDGE != ChEdgeState))
    {
#if (defined (FTM_PWM_IP_NOTIFICATION_SUPPORTED) && (FTM_PWM_IP_NOTIFICATION_SUPPORTED == STD_ON))
        LgChannelIdx = (FTM_PWM_IP_CHANNEL_COUNT * Instance) + HwChannel;
...
#if (defined FTM_PWM_IP_0_OVF_ISR_USED)
/**
...
#if (defined FTM_PWM_IP_1_OVF_ISR_USED)
/**
 * @brief          Independent interrupt handler.
...
#if (defined FTM_PWM_IP_2_OVF_ISR_USED)
/**
 * @brief          Independent interrupt handler.
...
#if (defined FTM_PWM_IP_3_OVF_ISR_USED)
/**
 * @brief          Independent interrupt handler.
...
#if (defined FTM_PWM_IP_4_OVF_ISR_USED)
/**
 * @brief          Independent interrupt handler.
...
#if (defined FTM_PWM_IP_5_OVF_ISR_USED)
/**
 * @brief          Independent interrupt handler.
...
#if (defined FTM_PWM_IP_6_OVF_ISR_USED)
/**
 * @brief          Independent interrupt handler.
...
#if (defined FTM_PWM_IP_7_OVF_ISR_USED)
/**
 * @brief          Independent interrupt handler.
