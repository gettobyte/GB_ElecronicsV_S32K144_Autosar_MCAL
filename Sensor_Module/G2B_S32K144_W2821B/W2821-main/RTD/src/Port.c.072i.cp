...
Port_Ipw_RefreshPortDirection/12 (Port_Ipw_RefreshPortDirection) @05cc0620
  Type: function
  ...
  Calls: 
Port_Ipw_SetPinMode/11 (Port_Ipw_SetPinMode) @05cc0460
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Port_Ipw_SetPinDirection/10 (Port_Ipw_SetPinDirection) @05cc02a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Port_Ipw_Init/9 (Port_Ipw_Init) @05cc00e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Port_Config/8 (Port_Config) @05d52c18
  Type: variable
...
Det_ReportError/7 (Det_ReportError) @05cc0000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Port_GetVersionInfo/6 (Port_GetVersionInfo) @05d53460
...
Port_RefreshPortDirection/5 (Port_RefreshPortDirection) @05d53e00
  Type: function definition analyzed
  Visibility: externally_visible public
...
Port_SetPinMode/4 (Port_SetPinMode) @05d53b60
  Type: function definition analyzed
  Visibility: externally_visible public
  References: Port_pConfigPtr/1 (read)
  Referring: 
...
Port_SetPinDirection/3 (Port_SetPinDirection) @05d538c0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: Port_pConfigPtr/1 (read)
  Referring: 
...
Port_Init/2 (Port_Init) @05d53620
  Type: function definition analyzed
  Visibility: externally_visible public
...
Port_pConfigPtr/1 (Port_pConfigPtr) @05d524c8
