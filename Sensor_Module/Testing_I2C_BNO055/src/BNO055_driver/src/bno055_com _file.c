 ...
 *
 ****************************************************************************/
BNO055_RETURN_FUNCTION_TYPE bno055_com_Init(struct bno055_t *bno055)
{

	BNO055_RETURN_FUNCTION_TYPE comres = BNO055_INIT_VALUE;
	//Link the function pointers for communication (late-binding)
	bno055->bus_read = bus_read;
	bno055->bus_write = bus_write;
 ...
 *
 ****************************************************************************/
BNO055_RETURN_FUNCTION_TYPE bus_read(unsigned char dev_addr,unsigned char reg_addr, unsigned char *reg_data, unsigned char cnt)
{
	BNO055_RETURN_FUNCTION_TYPE comres = BNO055_INIT_VALUE;
 ...
 *
 ****************************************************************************/
BNO055_RETURN_FUNCTION_TYPE bus_write(unsigned char dev_addr,unsigned char reg_addr, unsigned char *reg_data, unsigned char cnt)
{
	BNO055_RETURN_FUNCTION_TYPE comres = BNO055_INIT_VALUE;
//	Wire.beginTransmission(dev_addr);	//Start of transmission
//	Wire.write(reg_addr);				//Desired start register
