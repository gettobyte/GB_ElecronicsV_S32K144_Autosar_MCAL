...
static const Port_PinConfigType Port_aPinConfigDefault_BOARD_InitPeripherals[PORT_MAX_CONFIGURED_PADS_U16]=
{
    ...
    { (uint16)3, (uint32)0x00000303, (uint8)1, (Port_PinDirectionType)3, (boolean)FALSE, (boolean)FALSE, (boolean)TRUE },
    /* PCR Id, PCR Value, Output Level, Direction, IsGpio, Direction Configurable, Mode Changeable */
    { (uint16)2, (uint32)0x00000303, (uint8)1, (Port_PinDirectionType)3, (boolean)FALSE, (boolean)FALSE, (boolean)TRUE }
};
