...
#define PORT_SW_MAJOR_VERSION_BOARD_InitPeripherals_PBCFG_C                1
...
*                                      FILE VERSION CHECKS
=================================================================================================*/
/* Check if the files Port_BOARD_InitPeripherals_PBcfg.c and Port.h are of the same vendor */
#if (PORT_VENDOR_ID_BOARD_InitPeripherals_PBCFG_C != PORT_VENDOR_ID_H)
    #error "Port_BOARD_InitPeripherals_PBcfg.c and Port.h have different vendor ids"
#endif
/* Check if the files Port_BOARD_InitPeripherals_PBcfg.c and Port.h are of the same Autosar version */
#if ((PORT_AR_RELEASE_MAJOR_VERSION_BOARD_InitPeripherals_PBCFG_C    != PORT_AR_RELEASE_MAJOR_VERSION_H)  || \
     (PORT_AR_RELEASE_MINOR_VERSION_BOARD_InitPeripherals_PBCFG_C    != PORT_AR_RELEASE_MINOR_VERSION_H)  || \
     (PORT_AR_RELEASE_REVISION_VERSION_BOARD_InitPeripherals_PBCFG_C != PORT_AR_RELEASE_REVISION_VERSION_H)  \
    )
    #error "AutoSar Version Numbers of Port_BOARD_InitPeripherals_PBcfg.c and Port.h are different"
#endif
/* Check if the files Port_BOARD_InitPeripherals_PBcfg.c and Port.h are of the same software version */
#if ((PORT_SW_MAJOR_VERSION_BOARD_InitPeripherals_PBCFG_C != PORT_SW_MAJOR_VERSION_H) || \
     (PORT_SW_MINOR_VERSION_BOARD_InitPeripherals_PBCFG_C != PORT_SW_MINOR_VERSION_H) || \
     (PORT_SW_PATCH_VERSION_BOARD_InitPeripherals_PBCFG_C != PORT_SW_PATCH_VERSION_H)    \
    )
...
*/
#define PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_BOARD_InitPeripherals_U8         (0U)
...
*/
static const uint16 Port_au16NoUnUsedPadsArrayDefault_BOARD_InitPeripherals[PORT_MAX_UNUSED_PADS_U16]=
{
    (uint16)0,
    (uint16)1,
    (uint16)2,
...
static const Port_PinConfigType Port_aPinConfigDefault_BOARD_InitPeripherals[PORT_MAX_CONFIGURED_PADS_U16]=
{
    ...
    /* PCR Id, PCR Value, Output Level, Direction, IsGpio, Direction Configurable, Mode Changeable */
    { (uint16)44, (uint32)0x00000100, (uint8)1, (Port_PinDirectionType)2, (boolean)TRUE, (boolean)TRUE, (boolean)TRUE },
    /* PCR Id, PCR Value, Output Level, Direction, IsGpio, Direction Configurable, Mode Changeable */
    { (uint16)45, (uint32)0x00000100, (uint8)1, (Port_PinDirectionType)2, (boolean)TRUE, (boolean)TRUE, (boolean)TRUE },
    /* PCR Id, PCR Value, Output Level, Direction, IsGpio, Direction Configurable, Mode Changeable */
    { (uint16)46, (uint32)0x00000300, (uint8)1, (Port_PinDirectionType)2, (boolean)FALSE, (boolean)FALSE, (boolean)TRUE },
    /* PCR Id, PCR Value, Output Level, Direction, IsGpio, Direction Configurable, Mode Changeable */
    { (uint16)47, (uint32)0x00000300, (uint8)1, (Port_PinDirectionType)2, (boolean)FALSE, (boolean)FALSE, (boolean)TRUE },
    /* PCR Id, PCR Value, Output Level, Direction, IsGpio, Direction Configurable, Mode Changeable */
    ...
    /* PCR Id, PCR Value, Output Level, Direction, IsGpio, Direction Configurable, Mode Changeable */
    { (uint16)37, (uint32)0x00000600, (uint8)0, (Port_PinDirectionType)1, (boolean)FALSE, (boolean)FALSE, (boolean)TRUE },
    /* PCR Id, PCR Value, Output Level, Direction, IsGpio, Direction Configurable, Mode Changeable */
    { (uint16)66, (uint32)0x00000000, (uint8)2, (Port_PinDirectionType)0, (boolean)FALSE, (boolean)FALSE, (boolean)TRUE }
};

#if (0UL != PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_BOARD_InitPeripherals_U8)
static const Port_Ci_Port_Ip_DigitalFilterConfigType Port_aDigitalFilter_BOARD_InitPeripherals[PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_BOARD_InitPeripherals_U8]=
{
};
#endif /* (0UL != PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_BOARD_InitPeripherals_U8) */
...
const Port_ConfigType Port_Config =
{
    ...
    Port_au16NoUnUsedPadsArrayDefault_BOARD_InitPeripherals,
#else
    NULL_PTR,
#endif
    &Port_UnUsedPin_BOARD_InitPeripherals,
    Port_aPinConfigDefault_BOARD_InitPeripherals,
    PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_BOARD_InitPeripherals_U8,
#if (0UL != PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_BOARD_InitPeripherals_U8)
    Port_aDigitalFilter_BOARD_InitPeripherals,
#else
    NULL_PTR,
#endif
