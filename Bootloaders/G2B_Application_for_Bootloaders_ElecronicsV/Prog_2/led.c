...
//  PTD->PSOR |= GPIO_PSOR_PTSO(0x00000001);
	...
	PORTD->PCR[16] = 0x00000100;  /* Port PTD15: MUX = GPIO */
	PTD->PDDR |= 1<<16;        /* Port PTD15: Data Direction= output */
	PTD->PSOR |= 1<<16;        /* Set Output on port D15 (LED on) */
} /*** end of LedInit ***/
