 ...
 * @brief Converts a clock name to a selector entry hardware value
 */
const uint8 Clock_Ip_au8SelectorEntryScsHardwareValue[CLOCK_IP_PRODUCERS_NO + 1U] = {
 ...
 * @brief Converts a clock name to a selector entry hardware value
 */
const uint8 Clock_Ip_au8SelectorEntryPcsHardwareValue[CLOCK_IP_PRODUCERS_NO + 1U] = {
