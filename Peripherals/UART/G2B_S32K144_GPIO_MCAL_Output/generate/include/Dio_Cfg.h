...
*
*/
#define DioConf_DioChannel_BlueLED  ((uint16)0x0060U)
/**
* @brief          Symbolic name for the channel RedLED.
*
*/
#define DioConf_DioChannel_RedLED  ((uint16)0x006fU)
/**
* @brief          Symbolic name for the channel GreenLED.
*
*/
#define DioConf_DioChannel_GreenLED  ((uint16)0x0070U)
/* ---------- DioPort_1 ---------- */
...
/**
* @brief          Symbolic name for the channel SW_1.
*
*/
#define DioConf_DioChannel_SW_1  ((uint16)0x004cU)
/**
* @brief          Symbolic name for the channel SW_2.
*
*/
#define DioConf_DioChannel_SW_2  ((uint16)0x004dU)
