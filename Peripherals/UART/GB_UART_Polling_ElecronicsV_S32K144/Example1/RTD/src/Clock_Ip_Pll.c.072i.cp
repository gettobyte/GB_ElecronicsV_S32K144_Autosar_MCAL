...
CompleteSpll.part.0/19 (CompleteSpll.part.0) @07668700
...
EnableSpll_TrustedCall.isra.0/18 (EnableSpll_TrustedCall.isra.0) @076681c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
DisableSpll_TrustedCall.isra.0/17 (DisableSpll_TrustedCall.isra.0) @075c9ee0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
ResetSpll_TrustedCall.isra.0/16 (ResetSpll_TrustedCall.isra.0) @075c99a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
ReportClockErrors/15 (ReportClockErrors) @069c4700
  Type: function
  ...
  Calls: 
ClockTimeoutExpired/14 (ClockTimeoutExpired) @069c4620
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
ClockStartTimeout/13 (ClockStartTimeout) @069c4540
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
EnableSpll/12 (EnableSpll) @069be380
  Type: function definition analyzed
...
DisableSpll/10 (DisableSpll) @069bea80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
CompleteSpll/8 (CompleteSpll) @069be540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetSpll_TrustedCall/6 (SetSpll_TrustedCall) @069be000
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  Referring: 
  ...
  Calls: 
ResetSpll/5 (ResetSpll) @068bda80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
Callback_PllEmptyDisable/3 (Callback_PllEmptyDisable) @068bd540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
Callback_PllEmptyComplete/2 (Callback_PllEmptyComplete) @068bd2a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
Callback_PllEmpty/1 (Callback_PllEmpty) @068bd000
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
pllCallbacks/0 (pllCallbacks) @068ba750
