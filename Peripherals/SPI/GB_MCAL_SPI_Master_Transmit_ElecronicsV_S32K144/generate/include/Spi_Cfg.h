...
#include "Spi_BOARD_INITPERIPHERALS_PBcfg.h"
...
/* Check if Spi_BOARD_INITPERIPHERALS_PBcfg header file and Spi configuration header file are of the same vendor */
#if (SPI_VENDOR_ID_BOARD_INITPERIPHERALS_PBCFG_H != SPI_VENDOR_ID_CFG)
    #error "Spi_BOARD_INITPERIPHERALS_PBcfg.h and Spi_Cfg.h have different vendor IDs"
#endif
    /* Check if Spi_BOARD_INITPERIPHERALS_PBcfg header file and Spi  configuration header file are of the same Autosar version */
#if ((SPI_AR_RELEASE_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H != SPI_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (SPI_AR_RELEASE_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H != SPI_AR_RELEASE_MINOR_VERSION_CFG) || \
     (SPI_AR_RELEASE_REVISION_VERSION_BOARD_INITPERIPHERALS_PBCFG_H != SPI_AR_RELEASE_REVISION_VERSION_CFG))
#error "AutoSar Version Numbers of Spi_BOARD_INITPERIPHERALS_PBcfg.h and Spi_Cfg.h are different"
#endif
/* Check if Spi_BOARD_INITPERIPHERALS_PBcfg header file and Spi configuration header file are of the same software version */
#if ((SPI_SW_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H != SPI_SW_MAJOR_VERSION_CFG) || \
     (SPI_SW_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H != SPI_SW_MINOR_VERSION_CFG) || \
     (SPI_SW_PATCH_VERSION_BOARD_INITPERIPHERALS_PBCFG_H != SPI_SW_PATCH_VERSION_CFG))
#error "Software Version Numbers of Spi_BOARD_INITPERIPHERALS_PBcfg.h and Spi_Cfg.h are different"
#endif
...
#define SPI_CONFIG_EXT \
    SPI_CONFIG_BOARD_InitPeripherals_PB \
