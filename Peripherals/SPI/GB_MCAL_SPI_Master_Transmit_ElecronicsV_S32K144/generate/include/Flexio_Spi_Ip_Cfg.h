...
#include "Mcal.h"
#include "OsIf.h"
#include "Flexio_Spi_Ip_BOARD_InitPeripherals_PBcfg.h"
...
/* Check if Flexio_Spi_Ip_BOARD_INITPERIPHERALS_PBcfg header file and Spi configuration header file are of the same vendor */
#if (FLEXIO_SPI_IP_BOARD_INITPERIPHERALS_VENDOR_ID_PBCFG != FLEXIO_SPI_IP_VENDOR_ID_CFG)
    #error "Flexio_Spi_Ip_BOARD_INITPERIPHERALS_PBcfg.h and FLEXIO_SPI_IP_Cfg.h have different vendor IDs"
#endif
    /* Check if Flexio_Spi_Ip_BOARD_INITPERIPHERALS_PBcfg header file and Spi  configuration header file are of the same Autosar version */
#if ((FLEXIO_SPI_IP_BOARD_INITPERIPHERALS_AR_RELEASE_MAJOR_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_BOARD_INITPERIPHERALS_AR_RELEASE_MINOR_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_MINOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_BOARD_INITPERIPHERALS_AR_RELEASE_REVISION_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_REVISION_VERSION_CFG))
    #error "AutoSar Version Numbers of Flexio_Spi_Ip_BOARD_INITPERIPHERALS_PBcfg.h and Flexio_Spi_Ip_Cfg.h are different"
#endif
...
#if ((FLEXIO_SPI_IP_BOARD_INITPERIPHERALS_SW_MAJOR_VERSION_PBCFG != FLEXIO_SPI_IP_SW_MAJOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_BOARD_INITPERIPHERALS_SW_MINOR_VERSION_PBCFG != FLEXIO_SPI_IP_SW_MINOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_BOARD_INITPERIPHERALS_SW_PATCH_VERSION_PBCFG != FLEXIO_SPI_IP_SW_PATCH_VERSION_CFG))
    #error "Software Version Numbers of Flexio_Spi_Ip_BOARD_INITPERIPHERALS_PBcfg.h and Flexio_Spi_Ip_Cfg.h are different"
#endif
/*==================================================================================================
                                            CONSTANTS
==================================================================================================*/
...
#define FLEXIO_SPI_IP_CONFIG_EXT \
    FLEXIO_SPI_IP_CONFIG_BOARD_InitPeripherals_PB \
