...
#define CACHE_IP_HWACC_LMEM_AR_RELEASE_MINOR_VERSION        4
#define CACHE_IP_HWACC_LMEM_AR_RELEASE_REVISION_VERSION     0
#define CACHE_IP_HWACC_LMEM_SW_MAJOR_VERSION                1
#define CACHE_IP_HWACC_LMEM_SW_MINOR_VERSION                0
#define CACHE_IP_HWACC_LMEM_SW_PATCH_VERSION                1
 ...
 *                                       LOCAL FUNCTIONS
==================================================================================================*/
LOCAL_INLINE Std_ReturnType hwAcc_Lmem_ControlReg(LMEM_Type * pInst, uint32 ControlMask, uint32 GoMask)
{
...
LOCAL_INLINE Std_ReturnType hwAcc_Lmem_LineControlReg(LMEM_Type * pInst, uint32 LineControlMask, uint32 GoMask)
{
    Std_ReturnType locStatus = (Std_ReturnType)E_OK;
    uint32 locTimeoutTicks = OsIf_MicrosToTicks(CACHE_IP_LMEM_COMMAND_TIMEOUT_VAL, CACHE_IP_LMEM_COMMAND_TIMEOUT_TYPE);
    uint32 locCurrentTicks = OsIf_GetCounter(CACHE_IP_LMEM_COMMAND_TIMEOUT_TYPE);
...
LOCAL_INLINE Std_ReturnType hwAcc_Lmem_AddressReg(LMEM_Type * pInst, uint32 Address, uint32 GoMask)
{
    Std_ReturnType locStatus = (Std_ReturnType)E_OK;
    uint32 locTimeoutTicks = OsIf_MicrosToTicks(CACHE_IP_LMEM_COMMAND_TIMEOUT_VAL, CACHE_IP_LMEM_COMMAND_TIMEOUT_TYPE);
    uint32 locCurrentTicks = OsIf_GetCounter(CACHE_IP_LMEM_COMMAND_TIMEOUT_TYPE);
...
LOCAL_INLINE Std_ReturnType hwAcc_Lmem_ProcessorCodeCacheEnable(void)
{
    Std_ReturnType locStatus = (Std_ReturnType)E_OK;
    uint32 locTimeoutTicks = OsIf_MicrosToTicks(CACHE_IP_LMEM_COMMAND_TIMEOUT_VAL, CACHE_IP_LMEM_COMMAND_TIMEOUT_TYPE);
    uint32 locCurrentTicks = OsIf_GetCounter(CACHE_IP_LMEM_COMMAND_TIMEOUT_TYPE);
...
LOCAL_INLINE Std_ReturnType hwAcc_Lmem_ProcessorCodeCacheDisable(void)
{
    Std_ReturnType locStatus = (Std_ReturnType)E_OK;
    uint32 locTimeoutTicks = OsIf_MicrosToTicks(CACHE_IP_LMEM_COMMAND_TIMEOUT_VAL, CACHE_IP_LMEM_COMMAND_TIMEOUT_TYPE);
    uint32 locCurrentTicks = OsIf_GetCounter(CACHE_IP_LMEM_COMMAND_TIMEOUT_TYPE);
...
LOCAL_INLINE Std_ReturnType hwAcc_Lmem_ProcessorCodeInvalidate(void)
{
    Std_ReturnType locStatus = (Std_ReturnType)E_OK;
...
LOCAL_INLINE Std_ReturnType hwAcc_Lmem_ProcessorCodeClean(const boolean enInvalidate)
{
    Std_ReturnType locStatus = (Std_ReturnType)E_OK;
...
LOCAL_INLINE Std_ReturnType hwAcc_Lmem_ProcessorCodeInvalidateByAddr(const uint32 addr, const uint32 length)
{
    Std_ReturnType locStatus = (Std_ReturnType)E_OK;
...
LOCAL_INLINE Std_ReturnType hwAcc_Lmem_ProcessorCodeCacheCleanByAddr(const boolean enInvalidate, const uint32 addr, const uint32 length)
{
    Std_ReturnType locStatus = (Std_ReturnType)E_OK;
    uint32 locStartAddr = addr & ~(CACHE_IP_LMEM_LINE_SIZE - 1U);
    uint32 locEndAddr = addr + length;
