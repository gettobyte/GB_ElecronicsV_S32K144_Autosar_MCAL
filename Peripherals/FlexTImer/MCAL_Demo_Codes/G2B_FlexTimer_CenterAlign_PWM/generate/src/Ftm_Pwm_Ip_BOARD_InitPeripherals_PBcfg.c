...
const Ftm_Pwm_Ip_SyncCfgType Ftm_Pwm_Ip_BOARD_InitPeripherals_SyncCfg1 =
{
    /* SyncMode */              FTM_PWM_IP_SYNC_SWTRIGGER,
    /* HwSync0 */               (boolean)FALSE,
    /* HwSync1 */               (boolean)FALSE,
...
const Ftm_Pwm_Ip_InstanceCfgType Ftm_Pwm_Ip_BOARD_InitPeripherals_InstCfg1 =
{
    ...
    /* FaultIrqEn */            (boolean)FALSE,
#endif    
    /* SyncCfg */               &Ftm_Pwm_Ip_BOARD_InitPeripherals_SyncCfg1
};
...
/* Ftm channel 0 configuration */
const Ftm_Pwm_Ip_ChannelConfigType Ftm_Pwm_Ip_BOARD_InitPeripherals_I1_Ch0 =
{
    /* ChannelId */             0U,
    /* ChannelMode */           FTM_PWM_IP_MODE_CENTER_ALIGNED_HIGH,
    /* ChIrqEn */               (boolean)FALSE,
    /* ChannelCb */             {
        /* FunctionCallback */      NULL_PTR,
        /* CbParam */               NULL_PTR
...
/* Ftm channels configuration array */
const Ftm_Pwm_Ip_ChannelConfigType * const Ftm_Pwm_Ip_BOARD_InitPeripherals_I1_ChArray[1U] =
{
    &Ftm_Pwm_Ip_BOARD_InitPeripherals_I1_Ch0
};

/* Ftm instance 1 User configuration structure */
const Ftm_Pwm_Ip_UserCfgType Ftm_Pwm_Ip_BOARD_InitPeripherals_UserCfg1 =
{
    /* InstanceCfg */           &Ftm_Pwm_Ip_BOARD_InitPeripherals_InstCfg1,
    /* ConfiguredChArray */     Ftm_Pwm_Ip_BOARD_InitPeripherals_I1_ChArray,
    /* NoOfConfiguredCh */      1U
#if (defined(FTM_PWM_IP_HAS_FAULT) && (FTM_PWM_IP_HAS_FAULT == STD_ON))
    ,
    /* ConfiguredFaultArray */  NULL_PTR,
