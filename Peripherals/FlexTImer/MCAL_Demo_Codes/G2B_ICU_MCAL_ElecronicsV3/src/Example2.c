...
void PORT_CI_ICU_IP_C_EXT_IRQ_ISR(void);
...
int main(void)
{
	 Clock_Ip_StatusType clockStatus;
		    ...
		    IntCtrl_Ip_InstallHandler(PORTC_IRQn, PORT_CI_ICU_IP_C_EXT_IRQ_ISR, NULL_PTR);
		    ...
		    Icu_EnableNotification(icu_channel1);

		    Icu_SetActivationCondition(icu_channel1, ICU_RISING_EDGE);

		    Icu_EnableEdgeDetection(icu_channel1);
