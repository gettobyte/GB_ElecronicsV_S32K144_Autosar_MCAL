 ...
 *     @addtogroup ftm_ip_trustedfunctions FTM 
 *     @{
 */
...
#define FTM_ICU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION     4
#define FTM_ICU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION  0
#define FTM_ICU_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION             1
#define FTM_ICU_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION             0
#define FTM_ICU_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION             1
