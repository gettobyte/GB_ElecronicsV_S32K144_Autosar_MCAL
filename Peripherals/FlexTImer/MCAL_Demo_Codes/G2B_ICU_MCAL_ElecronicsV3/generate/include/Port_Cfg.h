...
*
*/
#define PortConfigSet_PWM_pins_PortPin_0 0
#define PortConfigSet_PWM_pins_PortPin_1 1
#define PortConfigSet_PWM_pins_switch1 2
#define PortConfigSet_PWM_pins_PortPin_3 3
