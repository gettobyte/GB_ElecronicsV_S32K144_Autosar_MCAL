...
#define FLEXIO_MCL_IP_BOARD_InitPeripherals_PBCFG_AR_RELEASE_MINOR_VERSION      4
#define FLEXIO_MCL_IP_BOARD_InitPeripherals_PBCFG_AR_RELEASE_REVISION_VERSION   0
#define FLEXIO_MCL_IP_BOARD_InitPeripherals_PBCFG_SW_MAJOR_VERSION              1
#define FLEXIO_MCL_IP_BOARD_InitPeripherals_PBCFG_SW_MINOR_VERSION              0
#define FLEXIO_MCL_IP_BOARD_InitPeripherals_PBCFG_SW_PATCH_VERSION              1
