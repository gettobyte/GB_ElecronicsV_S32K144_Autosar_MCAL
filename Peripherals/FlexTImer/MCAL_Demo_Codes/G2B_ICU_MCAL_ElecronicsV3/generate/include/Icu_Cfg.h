...
#include "Icu_BOARD_InitPeripherals_PBcfg.h"
...
#if (ICU_BOARD_INITPERIPHERALS_PBCFG_VENDOR_ID != ICU_CFG_VENDOR_ID)
    #error "Icu_BOARD_INITPERIPHERALS_PBcfg.h and Icu_Cfg.h have different vendor IDs"
#endif
/* Check if header file and Icu configuration header file are of the same Autosar version */
#if ((ICU_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MAJOR_VERSION != ICU_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (ICU_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MINOR_VERSION != ICU_CFG_AR_RELEASE_MINOR_VERSION) || \
     (ICU_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_REVISION_VERSION != ICU_CFG_AR_RELEASE_REVISION_VERSION) \
    )
#error "AutoSar Version Numbers of Icu_BOARD_INITPERIPHERALS_PBcfg.h and Icu_Cfg.h are different"
#endif
/* Check if header file and Icu configuration header file are of the same software version */
#if ((ICU_BOARD_INITPERIPHERALS_PBCFG_SW_MAJOR_VERSION != ICU_CFG_SW_MAJOR_VERSION) || \
     (ICU_BOARD_INITPERIPHERALS_PBCFG_SW_MINOR_VERSION != ICU_CFG_SW_MINOR_VERSION) || \
     (ICU_BOARD_INITPERIPHERALS_PBCFG_SW_PATCH_VERSION != ICU_CFG_SW_PATCH_VERSION) \
    )
#error "Software Version Numbers of Icu_BOARD_INITPERIPHERALS_PBcfg.h and Icu_Cfg.h are different"
#endif
...
#define ICU_CONFIG_EXT \
        ICU_CONFIG_BOARD_INITPERIPHERALS_PB \
