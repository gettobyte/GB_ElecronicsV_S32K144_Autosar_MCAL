...
C_SRCS += \
../generate/src/Ftm_Ocu_Ip_BOARD_InitPeripherals_PBcfg.c \
...
OBJS += \
./generate/src/Ftm_Ocu_Ip_BOARD_InitPeripherals_PBcfg.o \
...
C_DEPS += \
./generate/src/Ftm_Ocu_Ip_BOARD_InitPeripherals_PBcfg.d \
...
generate/src/%.o: ../generate/src/%.c
	...
	arm-none-eabi-gcc "@generate/src/Ftm_Ocu_Ip_BOARD_InitPeripherals_PBcfg.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
