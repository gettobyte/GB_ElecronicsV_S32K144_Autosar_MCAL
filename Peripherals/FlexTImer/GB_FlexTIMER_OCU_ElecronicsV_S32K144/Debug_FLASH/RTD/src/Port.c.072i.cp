...
Port_Ipw_RefreshPortDirection/12 (Port_Ipw_RefreshPortDirection) @0697f540
  Type: function
  ...
  Calls: 
Port_Ipw_SetPinMode/11 (Port_Ipw_SetPinMode) @0697f000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Port_Ipw_SetPinDirection/10 (Port_Ipw_SetPinDirection) @0697fe00
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Port_Ipw_Init/9 (Port_Ipw_Init) @0697fc40
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Port_Config/8 (Port_Config) @06979948
  Type: variable
  ...
  Availability: not_available
  Varpool flags:
Det_ReportError/7 (Det_ReportError) @0697fb60
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Port_GetVersionInfo/6 (Port_GetVersionInfo) @0697f700
...
Port_RefreshPortDirection/5 (Port_RefreshPortDirection) @0697f460
  Type: function definition analyzed
  Visibility: externally_visible public
...
Port_SetPinMode/4 (Port_SetPinMode) @0697f1c0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: Port_pConfig/1 (read)
  Referring: 
...
Port_SetPinDirection/3 (Port_SetPinDirection) @0696ce00
  Type: function definition analyzed
  Visibility: externally_visible public
  References: Port_pConfig/1 (read)
  Referring: 
...
Port_Init/2 (Port_Init) @0696cd20
  Type: function definition analyzed
  Visibility: externally_visible public
...
Port_pConfig/1 (Port_pConfig) @069791b0
