...
Det_Start/16 (Det_Start) @068312a0
...
Det_ReportTransientFault/15 (Det_ReportTransientFault) @06831000
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
Det_ReportRuntimeError/14 (Det_ReportRuntimeError) @0682dc40
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
Det_ReportError/13 (Det_ReportError) @0682de00
  Type: function definition analyzed
  Visibility: externally_visible public
...
Det_Init/12 (Det_Init) @0682db60
  ...
  Calls: 
Det_RuntimeModuleId/11 (Det_RuntimeModuleId) @06826ee8
  ...
  Availability: available
  Varpool flags:
Det_ModuleId/10 (Det_ModuleId) @06826ea0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  ...
  Availability: available
  Varpool flags:
Det_TransientModuleId/9 (Det_TransientModuleId) @06826e58
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  ...
  Availability: available
  Varpool flags:
Det_TransientFaultId/8 (Det_TransientFaultId) @06826e10
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_TransientApiId/7 (Det_TransientApiId) @06826dc8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_TransientInstanceId/6 (Det_TransientInstanceId) @06826d80
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_RuntimeErrorId/5 (Det_RuntimeErrorId) @06826d38
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_RuntimeApiId/4 (Det_RuntimeApiId) @06826cf0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_RuntimeInstanceId/3 (Det_RuntimeInstanceId) @06826ca8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_ErrorId/2 (Det_ErrorId) @06826c60
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
  Availability: available
  Varpool flags:
Det_ApiId/1 (Det_ApiId) @06826c18
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
  Availability: available
  Varpool flags:
Det_InstanceId/0 (Det_InstanceId) @06826bd0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
