...
Det_Start/16 (Det_Start) @05b89b60
...
Det_ReportTransientFault/15 (Det_ReportTransientFault) @05b89620
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
Det_ReportRuntimeError/14 (Det_ReportRuntimeError) @05b89d20
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
Det_ReportError/13 (Det_ReportError) @05b89a80
  Type: function definition analyzed
  Visibility: externally_visible public
...
Det_Init/12 (Det_Init) @05b897e0
  ...
  Calls: 
Det_RuntimeModuleId/11 (Det_RuntimeModuleId) @05c09ee8
  ...
  Availability: available
  Varpool flags:
Det_ModuleId/10 (Det_ModuleId) @05c09ea0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  ...
  Availability: available
  Varpool flags:
Det_TransientModuleId/9 (Det_TransientModuleId) @05c09e58
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  ...
  Availability: available
  Varpool flags:
Det_TransientFaultId/8 (Det_TransientFaultId) @05c09e10
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_TransientApiId/7 (Det_TransientApiId) @05c09dc8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_TransientInstanceId/6 (Det_TransientInstanceId) @05c09d80
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_RuntimeErrorId/5 (Det_RuntimeErrorId) @05c09d38
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_RuntimeApiId/4 (Det_RuntimeApiId) @05c09cf0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_RuntimeInstanceId/3 (Det_RuntimeInstanceId) @05c09ca8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_ErrorId/2 (Det_ErrorId) @05c09c60
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
  Availability: available
  Varpool flags:
Det_ApiId/1 (Det_ApiId) @05c09c18
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
  Availability: available
  Varpool flags:
Det_InstanceId/0 (Det_InstanceId) @05c09bd0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
