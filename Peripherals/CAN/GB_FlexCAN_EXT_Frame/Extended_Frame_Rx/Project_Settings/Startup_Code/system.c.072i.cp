...
sys_m4_cache_init.constprop.0/7 (sys_m4_cache_init.constprop) @06b5cee0
  ...
  Calls: 
SystemInit/6 (SystemInit) @06b5c0e0
  Type: function definition analyzed
...
Sys_GetCoreID/4 (Sys_GetCoreID) @06b5cd20
  Type: function definition analyzed
  ...
  Called by: 
  Calls: 
default_interrupt_routine/3 (default_interrupt_routine) @06b5ca80
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
startup_go_to_user_mode/2 (startup_go_to_user_mode) @06b5c7e0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
sys_m4_cache_init/1 (sys_m4_cache_init) @06b5c460
  Type: function
  ...
  Called by: 
  Calls: 
RESET_CATCH_CORE/0 (RESET_CATCH_CORE) @06b5aa68
