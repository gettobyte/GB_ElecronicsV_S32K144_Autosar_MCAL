...
OsIf_GetElapsed/7 (OsIf_GetElapsed) @05bd4540
  Type: function
  ...
  Calls: 
OsIf_MicrosToTicks/6 (OsIf_MicrosToTicks) @05bd4380
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OsIf_GetCounter/5 (OsIf_GetCounter) @05bd42a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: Power_Ip_StartTimeout/2 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
Power_Ip_pfReportErrorsCallback/4 (Power_Ip_pfReportErrorsCallback) @05bd09d8
  Type: variable
  ...
  Availability: not_available
  Varpool flags:
Power_Ip_TimeoutExpired/3 (Power_Ip_TimeoutExpired) @05bcb620
...
Power_Ip_StartTimeout/2 (Power_Ip_StartTimeout) @05bcbd20
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Power_Ip_ReportPowerErrorsEmptyCallback/1 (Power_Ip_ReportPowerErrorsEmptyCallback) @05bcba80
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
Power_Ip_ReportPowerErrors/0 (Power_Ip_ReportPowerErrors) @05bcb7e0
  Type: function definition analyzed
  Visibility: externally_visible public
