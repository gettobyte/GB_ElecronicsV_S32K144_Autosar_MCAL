...
Can_ProcessBusOffInterrupt/1 (Can_ProcessBusOffInterrupt) @06db52a0
  Type: function
  ...
  Calls: 
Can_ErrorIrqCallback/0 (Can_ErrorIrqCallback) @06cd11c0
...
;; Function Can_ErrorIrqCallback (Can_ErrorIrqCallback, funcdef_no=0, decl_uid=6722, cgraph_uid=1, symbol_order=0)
