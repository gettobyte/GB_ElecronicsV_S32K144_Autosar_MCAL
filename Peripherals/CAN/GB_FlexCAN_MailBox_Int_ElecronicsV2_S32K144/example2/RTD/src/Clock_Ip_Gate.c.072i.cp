...
ClockSetSimTraceEnable_TrustedCall.isra.0/27 (ClockSetSimTraceEnable_TrustedCall.isra.0) @0769e000
  ...
  Calls: 
ClockSetSimClkoutEnable_TrustedCall.isra.0/24 (ClockSetSimClkoutEnable_TrustedCall.isra.0) @075dfd20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
ClockSetSimLPO32KEnable_TrustedCall.isra.0/23 (ClockSetSimLPO32KEnable_TrustedCall.isra.0) @075df540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
ClockSetSimLPO1KEnable_TrustedCall.isra.0/22 (ClockSetSimLPO1KEnable_TrustedCall.isra.0) @075d3d20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
clockFeatures/21 (clockFeatures) @075c11b0
  Type: variable
...
ClockUpdateSimTraceEnable/20 (ClockUpdateSimTraceEnable) @069c6ee0
  Type: function definition analyzed
...
ClockSetSimTraceEnable/19 (ClockSetSimTraceEnable) @069c6700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimGate/17 (ClockUpdateSimGate) @069c6b60
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimGate/16 (ClockSetSimGate) @069c68c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: ClockSetSimGate_TrustedCall/15 (1073741824 (estimated locally),1.00 per call) 
ClockSetSimGate_TrustedCall/15 (ClockSetSimGate_TrustedCall) @069c6620
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  ...
  Calls: 
ClockUpdatePccCgcEnable/14 (ClockUpdatePccCgcEnable) @069c62a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetPccCgcEnable/13 (ClockSetPccCgcEnable) @069c6000
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: ClockSetPccCgcEnable_TrustedCall/12 (1073741824 (estimated locally),1.00 per call) 
ClockSetPccCgcEnable_TrustedCall/12 (ClockSetPccCgcEnable_TrustedCall) @069c0a80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: clockFeatures/21 (read)
  Referring: 
  ...
  Calls: 
ClockUpdateSimClkoutEnable/11 (ClockUpdateSimClkoutEnable) @069c0ee0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimClkoutEnable/10 (ClockSetSimClkoutEnable) @069c0c40
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimLPO32KEnable/8 (ClockUpdateSimLPO32KEnable) @069c0700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimLPO32KEnable/7 (ClockSetSimLPO32KEnable) @069c0460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimLPO1KEnable/5 (ClockUpdateSimLPO1KEnable) @068c0e00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimLPO1KEnable/4 (ClockSetSimLPO1KEnable) @068c0620
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateGateEmpty/2 (ClockUpdateGateEmpty) @068c0a80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
ClockSetGateEmpty/1 (ClockSetGateEmpty) @068c07e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
gateCallbacks/0 (gateCallbacks) @068be5e8
