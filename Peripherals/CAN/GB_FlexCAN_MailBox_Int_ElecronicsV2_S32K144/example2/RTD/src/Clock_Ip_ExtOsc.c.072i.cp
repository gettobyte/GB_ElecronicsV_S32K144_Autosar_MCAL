...
ResetSOSC_TrustedCall.isra.0/15 (ResetSOSC_TrustedCall.isra.0) @075d77e0
  ...
  Calls: 
ReportClockErrors/14 (ReportClockErrors) @069eaa80
  Type: function
  ...
  Calls: 
ClockTimeoutExpired/13 (ClockTimeoutExpired) @069ea9a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
ClockStartTimeout/12 (ClockStartTimeout) @069ea8c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
EnableSOSC/11 (EnableSOSC) @069ea000
  Type: function definition analyzed
...
DisableSOSC/9 (DisableSOSC) @069e4e00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
CompleteSOSC/7 (CompleteSOSC) @069e48c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetSOSC_TrustedCall/5 (SetSOSC_TrustedCall) @069e4380
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  Referring: 
  ...
  Calls: 
ResetSOSC/4 (ResetSOSC) @068c29a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
DisableExternalOscillatorEmpty/2 (DisableExternalOscillatorEmpty) @068c2460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
ExternalOscillatorEmpty/1 (ExternalOscillatorEmpty) @068c21c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
extOscCallbacks/0 (extOscCallbacks) @068bf630
