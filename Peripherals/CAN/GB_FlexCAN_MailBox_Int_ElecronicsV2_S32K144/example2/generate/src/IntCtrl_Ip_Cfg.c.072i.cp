...
undefined_handler/4 (undefined_handler) @06b67380
  Type: function
  ...
  Called by: 
  Calls: 
intRouteConfig/3 (intRouteConfig) @06b66c18
...
aIrqRouteConfig/2 (aIrqRouteConfig) @06b66bd0
  Type: variable definition analyzed
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
IntCtrlConfig_0/1 (IntCtrlConfig_0) @06b66af8
  Type: variable definition analyzed
  Visibility: externally_visible public
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
aIrqConfiguration1/0 (aIrqConfiguration1) @06b66ab0
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
