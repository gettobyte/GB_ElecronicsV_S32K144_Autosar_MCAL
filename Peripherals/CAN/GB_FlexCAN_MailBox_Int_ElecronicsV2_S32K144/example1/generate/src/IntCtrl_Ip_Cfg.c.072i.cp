...
undefined_handler/4 (undefined_handler) @06bc2380
  Type: function
  ...
  Called by: 
  Calls: 
intRouteConfig/3 (intRouteConfig) @06bc1c18
...
aIrqRouteConfig/2 (aIrqRouteConfig) @06bc1bd0
  Type: variable definition analyzed
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
IntCtrlConfig_0/1 (IntCtrlConfig_0) @06bc1af8
  Type: variable definition analyzed
  Visibility: externally_visible public
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
aIrqConfiguration1/0 (aIrqConfiguration1) @06bc1ab0
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
