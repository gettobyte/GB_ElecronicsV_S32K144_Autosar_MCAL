...
undefined_handler/4 (undefined_handler) @06b62380
  Type: function
  ...
  Called by: 
  Calls: 
intRouteConfig/3 (intRouteConfig) @06b61c18
...
aIrqRouteConfig/2 (aIrqRouteConfig) @06b61bd0
  Type: variable definition analyzed
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
IntCtrlConfig_0/1 (IntCtrlConfig_0) @06b61af8
  Type: variable definition analyzed
  Visibility: externally_visible public
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
aIrqConfiguration1/0 (aIrqConfiguration1) @06b61ab0
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
