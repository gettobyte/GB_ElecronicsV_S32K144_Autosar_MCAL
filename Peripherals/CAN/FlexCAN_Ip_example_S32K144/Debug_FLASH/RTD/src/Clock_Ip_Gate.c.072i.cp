...
ClockSetSimTraceEnable_TrustedCall.isra.0/27 (ClockSetSimTraceEnable_TrustedCall.isra.0) @07695a80
  ...
  Calls: 
ClockSetSimClkoutEnable_TrustedCall.isra.0/24 (ClockSetSimClkoutEnable_TrustedCall.isra.0) @076959a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
ClockSetSimLPO32KEnable_TrustedCall.isra.0/23 (ClockSetSimLPO32KEnable_TrustedCall.isra.0) @076951c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
ClockSetSimLPO1KEnable_TrustedCall.isra.0/22 (ClockSetSimLPO1KEnable_TrustedCall.isra.0) @075c3b60
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
clockFeatures/21 (clockFeatures) @075b11f8
  Type: variable
...
ClockUpdateSimTraceEnable/20 (ClockUpdateSimTraceEnable) @069c08c0
  Type: function definition analyzed
...
ClockSetSimTraceEnable/19 (ClockSetSimTraceEnable) @069c0000
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimGate/17 (ClockUpdateSimGate) @069c0a80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimGate/16 (ClockSetSimGate) @069c07e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: ClockSetSimGate_TrustedCall/15 (1073741824 (estimated locally),1.00 per call) 
ClockSetSimGate_TrustedCall/15 (ClockSetSimGate_TrustedCall) @069c0540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  ...
  Calls: 
ClockUpdatePccCgcEnable/14 (ClockUpdatePccCgcEnable) @069c01c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetPccCgcEnable/13 (ClockSetPccCgcEnable) @069bbc40
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: ClockSetPccCgcEnable_TrustedCall/12 (1073741824 (estimated locally),1.00 per call) 
ClockSetPccCgcEnable_TrustedCall/12 (ClockSetPccCgcEnable_TrustedCall) @069bb460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: clockFeatures/21 (read)
  Referring: 
  ...
  Calls: 
ClockUpdateSimClkoutEnable/11 (ClockUpdateSimClkoutEnable) @069bbe00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimClkoutEnable/10 (ClockSetSimClkoutEnable) @069bbb60
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimLPO32KEnable/8 (ClockUpdateSimLPO32KEnable) @069bb620
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimLPO32KEnable/7 (ClockSetSimLPO32KEnable) @069bb380
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimLPO1KEnable/5 (ClockUpdateSimLPO1KEnable) @068bb7e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimLPO1KEnable/4 (ClockSetSimLPO1KEnable) @068bbee0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateGateEmpty/2 (ClockUpdateGateEmpty) @068bb9a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
ClockSetGateEmpty/1 (ClockSetGateEmpty) @068bb700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
gateCallbacks/0 (gateCallbacks) @068b9630
...
;; Function ClockSetGateEmpty (ClockSetGateEmpty, funcdef_no=0, decl_uid=6055, cgraph_uid=1, symbol_order=1)
...
;; Function ClockUpdateGateEmpty (ClockUpdateGateEmpty, funcdef_no=1, decl_uid=6058, cgraph_uid=2, symbol_order=2)
...
;; Function ClockUpdatePccCgcEnable (ClockUpdatePccCgcEnable, funcdef_no=13, decl_uid=6078, cgraph_uid=14, symbol_order=14)
...
;; Function ClockSetSimGate_TrustedCall (ClockSetSimGate_TrustedCall, funcdef_no=14, decl_uid=6146, cgraph_uid=15, symbol_order=15)
...
;; Function ClockSetSimGate (ClockSetSimGate, funcdef_no=15, decl_uid=6080, cgraph_uid=16, symbol_order=16)
...
;; Function ClockUpdateSimGate (ClockUpdateSimGate, funcdef_no=16, decl_uid=6083, cgraph_uid=17, symbol_order=17)
...
;; Function ClockSetSimLPO1KEnable (ClockSetSimLPO1KEnable, funcdef_no=3, decl_uid=6060, cgraph_uid=4, symbol_order=4)
...
;; Function ClockUpdateSimLPO1KEnable (ClockUpdateSimLPO1KEnable, funcdef_no=4, decl_uid=6063, cgraph_uid=5, symbol_order=5)
...
;; Function ClockSetSimLPO32KEnable (ClockSetSimLPO32KEnable, funcdef_no=6, decl_uid=6065, cgraph_uid=7, symbol_order=7)
...
;; Function ClockUpdateSimLPO32KEnable (ClockUpdateSimLPO32KEnable, funcdef_no=7, decl_uid=6068, cgraph_uid=8, symbol_order=8)
...
;; Function ClockSetSimClkoutEnable (ClockSetSimClkoutEnable, funcdef_no=9, decl_uid=6070, cgraph_uid=10, symbol_order=10)
...
;; Function ClockUpdateSimClkoutEnable (ClockUpdateSimClkoutEnable, funcdef_no=10, decl_uid=6073, cgraph_uid=11, symbol_order=11)
...
;; Function ClockSetSimTraceEnable (ClockSetSimTraceEnable, funcdef_no=18, decl_uid=6085, cgraph_uid=19, symbol_order=19)
...
;; Function ClockUpdateSimTraceEnable (ClockUpdateSimTraceEnable, funcdef_no=19, decl_uid=6088, cgraph_uid=20, symbol_order=20)
...
;; Function ClockSetPccCgcEnable (ClockSetPccCgcEnable, funcdef_no=12, decl_uid=6075, cgraph_uid=13, symbol_order=13)
