...
SetSimClkoutDiv_TrustedCall.isra.0/42 (SetSimClkoutDiv_TrustedCall.isra.0) @076a3e00
  ...
  Calls: 
SetScgHsrunDivslow_TrustedCall.isra.0/41 (SetScgHsrunDivslow_TrustedCall.isra.0) @076a3700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
SetScgHsrunDivbus_TrustedCall.isra.0/40 (SetScgHsrunDivbus_TrustedCall.isra.0) @076a30e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
SetScgHsrunDivcore_TrustedCall.isra.0/39 (SetScgHsrunDivcore_TrustedCall.isra.0) @07697d20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
SetScgVlprDivslow_TrustedCall.isra.0/38 (SetScgVlprDivslow_TrustedCall.isra.0) @07697700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
SetScgVlprDivbus_TrustedCall.isra.0/37 (SetScgVlprDivbus_TrustedCall.isra.0) @076970e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
SetScgVlprDivcore_TrustedCall.isra.0/36 (SetScgVlprDivcore_TrustedCall.isra.0) @075ebd20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
SetScgRunDivslow_TrustedCall.isra.0/35 (SetScgRunDivslow_TrustedCall.isra.0) @075eb700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
SetScgRunDivbus_TrustedCall.isra.0/34 (SetScgRunDivbus_TrustedCall.isra.0) @075eb0e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
SetScgRunDivcore_TrustedCall.isra.0/33 (SetScgRunDivcore_TrustedCall.isra.0) @075b3d20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
scgPeriphAsyncDivs/32 (scgPeriphAsyncDivs) @075a5480
  Type: variable
...
dividerValue_hardwareValue/31 (dividerValue_hardwareValue) @075a5438
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
clockFeatures/30 (clockFeatures) @06a4e828
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
SetSimTraceDivMul/29 (SetSimTraceDivMul) @06a539a0
  Type: function definition analyzed
...
SetSimTraceDivMul_TrustedCall/28 (SetSimTraceDivMul_TrustedCall) @06a53700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  Referring: 
  ...
  Calls: 
SetPccPcdDivFrac/27 (SetPccPcdDivFrac) @06a53460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetPccPcdDivFrac_TrustedCall/26 (SetPccPcdDivFrac_TrustedCall) @06a531c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  ...
  Calls: 
SetSimClkoutDiv/25 (SetSimClkoutDiv) @06a4d8c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgHsrunDivslow/23 (SetScgHsrunDivslow) @06a4da80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgHsrunDivbus/21 (SetScgHsrunDivbus) @06a4d540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgHsrunDivcore/19 (SetScgHsrunDivcore) @06a4d000
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgVlprDivslow/17 (SetScgVlprDivslow) @06a49e00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgVlprDivbus/15 (SetScgVlprDivbus) @06a498c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgVlprDivcore/13 (SetScgVlprDivcore) @06a49380
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgRunDivslow/11 (SetScgRunDivslow) @06a44540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgRunDivbus/9 (SetScgRunDivbus) @06a44c40
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgRunDivcore/7 (SetScgRunDivcore) @06a44700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgAsyncDiv2/5 (SetScgAsyncDiv2) @06a441c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgAsyncDiv2_TrustedCall/4 (SetScgAsyncDiv2_TrustedCall) @06924c40
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  ...
  Calls: 
SetScgAsyncDiv1/3 (SetScgAsyncDiv1) @06924e00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
SetScgAsyncDiv1_TrustedCall/2 (SetScgAsyncDiv1_TrustedCall) @06924b60
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: clockFeatures/30 (read)dividerValue_hardwareValue/31 (read)scgPeriphAsyncDivs/32 (read)
  Referring: 
  ...
  Calls: 
Callback_DividerEmpty/1 (Callback_DividerEmpty) @069248c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
dividerCallbacks/0 (dividerCallbacks) @06922948
...
;; Function Callback_DividerEmpty (Callback_DividerEmpty, funcdef_no=0, decl_uid=6055, cgraph_uid=1, symbol_order=1)
...
;; Function SetScgAsyncDiv1 (SetScgAsyncDiv1, funcdef_no=2, decl_uid=6057, cgraph_uid=3, symbol_order=3)
...
;; Function SetScgAsyncDiv2 (SetScgAsyncDiv2, funcdef_no=4, decl_uid=6059, cgraph_uid=5, symbol_order=5)
...
;; Function SetPccPcdDivFrac (SetPccPcdDivFrac, funcdef_no=26, decl_uid=6081, cgraph_uid=27, symbol_order=27)
...
;; Function SetSimTraceDivMul (SetSimTraceDivMul, funcdef_no=28, decl_uid=6083, cgraph_uid=29, symbol_order=29)
...
;; Function SetScgRunDivcore (SetScgRunDivcore, funcdef_no=6, decl_uid=6061, cgraph_uid=7, symbol_order=7)
...
;; Function SetScgRunDivbus (SetScgRunDivbus, funcdef_no=8, decl_uid=6063, cgraph_uid=9, symbol_order=9)
...
;; Function SetScgRunDivslow (SetScgRunDivslow, funcdef_no=10, decl_uid=6065, cgraph_uid=11, symbol_order=11)
...
;; Function SetScgVlprDivcore (SetScgVlprDivcore, funcdef_no=12, decl_uid=6067, cgraph_uid=13, symbol_order=13)
...
;; Function SetScgVlprDivbus (SetScgVlprDivbus, funcdef_no=14, decl_uid=6069, cgraph_uid=15, symbol_order=15)
...
;; Function SetScgVlprDivslow (SetScgVlprDivslow, funcdef_no=16, decl_uid=6071, cgraph_uid=17, symbol_order=17)
...
;; Function SetScgHsrunDivcore (SetScgHsrunDivcore, funcdef_no=18, decl_uid=6073, cgraph_uid=19, symbol_order=19)
...
;; Function SetScgHsrunDivbus (SetScgHsrunDivbus, funcdef_no=20, decl_uid=6075, cgraph_uid=21, symbol_order=21)
...
;; Function SetScgHsrunDivslow (SetScgHsrunDivslow, funcdef_no=22, decl_uid=6077, cgraph_uid=23, symbol_order=23)
...
;; Function SetSimClkoutDiv (SetSimClkoutDiv, funcdef_no=24, decl_uid=6079, cgraph_uid=25, symbol_order=25)
