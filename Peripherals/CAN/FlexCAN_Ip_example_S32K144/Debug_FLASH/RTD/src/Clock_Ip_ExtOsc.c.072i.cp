...
Determining dynamic type for call: CompleteSOSC.part.0 (config_15(D));
  ...
  Function call may change dynamic type:TimeoutOccurred_14 = ClockTimeoutExpired (&StartTime, &ElapsedTime, TimeoutTicks.0_6);
Determining dynamic type for call: SetSOSC_TrustedCall (config_4(D));
  Starting walk at: SetSOSC_TrustedCall (config_4(D));
  instance pointer: config_4(D)  Outer instance pointer: config_4(D) offset: 0 (bits) vtbl reference: 

IPA structures before propagation:

Jump functions:
  Jump functions of caller  CompleteSOSC.part.0/19:
  Jump functions of caller  EnableSOSC_TrustedCall.isra.0/18:
  Jump functions of caller  DisableSOSC_TrustedCall.isra.0/17:
  Jump functions of caller  ResetSOSC_TrustedCall.isra.0/16:
  Jump functions of caller  SetExternalOscillatorFrequency/15:
  ...
  Jump functions of caller  EnableSOSC/11:
    callsite  EnableSOSC/11 -> EnableSOSC_TrustedCall.isra.0/18 : 
       param 0: UNKNOWN
         value: 0x0, mask: 0xffff
         Unknown VR
  Jump functions of caller  DisableSOSC/9:
    callsite  DisableSOSC/9 -> DisableSOSC_TrustedCall.isra.0/17 : 
  Jump functions of caller  CompleteSOSC/7:
    callsite  CompleteSOSC/7 -> CompleteSOSC.part.0/19 : 
  ...
  Jump functions of caller  ResetSOSC/4:
    callsite  ResetSOSC/4 -> ResetSOSC_TrustedCall.isra.0/16 : 
...
overall_size: 150, max_new_size: 11001
...
Lattices:
  Node: CompleteSOSC.part.0/19:
    param [0]: VARIABLE
         ctxs: VARIABLE
         Bits unusable (BOTTOM)
         VARYING
        AGGS VARIABLE
  Node: EnableSOSC_TrustedCall.isra.0/18:
    param [0]: VARIABLE
         ctxs: VARIABLE
         Bits unusable (BOTTOM)
         VARYING
        AGGS VARIABLE
  Node: DisableSOSC_TrustedCall.isra.0/17:
  Node: ResetSOSC_TrustedCall.isra.0/16:
  Node: EnableSOSC/11:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
...
CompleteSOSC.part.0/19 (CompleteSOSC.part.0) @07658540
...
EnableSOSC_TrustedCall.isra.0/18 (EnableSOSC_TrustedCall.isra.0) @07658000
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
DisableSOSC_TrustedCall.isra.0/17 (DisableSOSC_TrustedCall.isra.0) @075bab60
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
ResetSOSC_TrustedCall.isra.0/16 (ResetSOSC_TrustedCall.isra.0) @075ba7e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
SetExternalOscillatorFrequency/15 (SetExternalOscillatorFrequency) @069b9b60
  Type: function
  ...
  Called by: SetSOSC/6 (1073741824 (estimated locally),1.00 per call) SetSOSC_TrustedCall/5 (217325345 (estimated locally),0.20 per call) 
  Calls: 
ReportClockErrors/14 (ReportClockErrors) @069b99a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  Availability: not_available
  Function flags: optimize_size
  Called by: CompleteSOSC.part.0/19 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
ClockTimeoutExpired/13 (ClockTimeoutExpired) @069b98c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
ClockStartTimeout/12 (ClockStartTimeout) @069b97e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
EnableSOSC/11 (EnableSOSC) @069b4b60
  Type: function definition analyzed
  ...
  Called by: 
  Calls: EnableSOSC_TrustedCall.isra.0/18 (1073741824 (estimated locally),1.00 per call) 
DisableSOSC/9 (DisableSOSC) @069b4d20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Function flags: count:1073741824 (estimated locally) body optimize_size
  Called by: 
  Calls: DisableSOSC_TrustedCall.isra.0/17 (1073741824 (estimated locally),1.00 per call) 
CompleteSOSC/7 (CompleteSOSC) @069b47e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: CompleteSOSC.part.0/19 (37904965 (estimated locally),0.11 per call) ClockTimeoutExpired/13 (1073741824 (estimated locally),3.08 per call) ClockStartTimeout/12 (114863532 (estimated locally),0.33 per call) 
SetSOSC/6 (SetSOSC) @069b4540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Function flags: count:1073741824 (estimated locally) body optimize_size
  Called by: 
  Calls: SetExternalOscillatorFrequency/15 (1073741824 (estimated locally),1.00 per call) SetSOSC_TrustedCall/5 (1073741824 (estimated locally),1.00 per call) 
SetSOSC_TrustedCall/5 (SetSOSC_TrustedCall) @069b42a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  Referring: 
  ...
  Calls: SetExternalOscillatorFrequency/15 (217325345 (estimated locally),0.20 per call) 
ResetSOSC/4 (ResetSOSC) @068b27e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Function flags: count:1073741824 (estimated locally) body optimize_size
  Called by: 
  Calls: ResetSOSC_TrustedCall.isra.0/16 (1073741824 (estimated locally),1.00 per call) 
DisableExternalOscillatorEmpty/2 (DisableExternalOscillatorEmpty) @068b22a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
ExternalOscillatorEmpty/1 (ExternalOscillatorEmpty) @068b2000
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
extOscCallbacks/0 (extOscCallbacks) @068af678
...
;; Function ExternalOscillatorEmpty (ExternalOscillatorEmpty, funcdef_no=0, decl_uid=6055, cgraph_uid=1, symbol_order=1)
...
;; Function DisableExternalOscillatorEmpty (DisableExternalOscillatorEmpty, funcdef_no=1, decl_uid=6057, cgraph_uid=2, symbol_order=2)
...
;; Function SetSOSC (SetSOSC, funcdef_no=5, decl_uid=6064, cgraph_uid=6, symbol_order=6)
...
SetSOSC (const struct Clock_Ip_XoscConfigType * config)
{
  ...
  <bb 2> [local count: 1073741824]:
  # DEBUG BEGIN_STMT
  SetSOSC_TrustedCall (config_4(D));
  # DEBUG BEGIN_STMT
  _1 = config_4(D)->name;
  _2 = config_4(D)->freq;
  SetExternalOscillatorFrequency (_1, _2);
  return;
...
;; Function ResetSOSC (ResetSOSC, funcdef_no=3, decl_uid=6062, cgraph_uid=4, symbol_order=4)
...
;; Function DisableSOSC (DisableSOSC, funcdef_no=8, decl_uid=6068, cgraph_uid=9, symbol_order=9)
...
;; Function EnableSOSC (EnableSOSC, funcdef_no=10, decl_uid=6070, cgraph_uid=11, symbol_order=11)
...
;; Function CompleteSOSC (CompleteSOSC, funcdef_no=6, decl_uid=6066, cgraph_uid=7, symbol_order=7)
