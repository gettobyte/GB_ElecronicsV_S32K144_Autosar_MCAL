...
Callback_FracDivEmptyComplete/2 (Callback_FracDivEmptyComplete) @06907ee0
  ...
  Called by: 
  Calls: 
Callback_FracDivEmpty/1 (Callback_FracDivEmpty) @06907c40
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
fracDivCallbacks/0 (fracDivCallbacks) @0690a1f8
...
;; Function Callback_FracDivEmpty (Callback_FracDivEmpty, funcdef_no=0, decl_uid=6055, cgraph_uid=1, symbol_order=1)
...
;; Function Callback_FracDivEmptyComplete (Callback_FracDivEmptyComplete, funcdef_no=1, decl_uid=6057, cgraph_uid=2, symbol_order=2)
