...
Det_Start/16 (Det_Start) @06747ee0
...
Det_ReportTransientFault/15 (Det_ReportTransientFault) @067479a0
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
Det_ReportRuntimeError/14 (Det_ReportRuntimeError) @06747e00
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
Det_ReportError/13 (Det_ReportError) @06747b60
  Type: function definition analyzed
  Visibility: externally_visible public
...
Det_Init/12 (Det_Init) @067478c0
  ...
  Calls: 
Det_RuntimeModuleId/11 (Det_RuntimeModuleId) @067c9f30
  ...
  Availability: available
  Varpool flags:
Det_ModuleId/10 (Det_ModuleId) @067c9ee8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  ...
  Availability: available
  Varpool flags:
Det_TransientModuleId/9 (Det_TransientModuleId) @067c9ea0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  ...
  Availability: available
  Varpool flags:
Det_TransientFaultId/8 (Det_TransientFaultId) @067c9e58
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_TransientApiId/7 (Det_TransientApiId) @067c9e10
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_TransientInstanceId/6 (Det_TransientInstanceId) @067c9dc8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_RuntimeErrorId/5 (Det_RuntimeErrorId) @067c9d80
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_RuntimeApiId/4 (Det_RuntimeApiId) @067c9d38
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_RuntimeInstanceId/3 (Det_RuntimeInstanceId) @067c9cf0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_ErrorId/2 (Det_ErrorId) @067c9ca8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
  Availability: available
  Varpool flags:
Det_ApiId/1 (Det_ApiId) @067c9c60
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
  Availability: available
  Varpool flags:
Det_InstanceId/0 (Det_InstanceId) @067c9c18
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
