...
ClockMonitorEmpty_GetStatus/4 (ClockMonitorEmpty_GetStatus) @0690ab60
  ...
  Called by: 
  Calls: 
ClockMonitorEmpty_ClearStatus/3 (ClockMonitorEmpty_ClearStatus) @0690a8c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockMonitorEmpty_Disable/2 (ClockMonitorEmpty_Disable) @0690a620
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Calls: 
ClockMonitorEmpty/1 (ClockMonitorEmpty) @0690a380
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
cmuCallbacks/0 (cmuCallbacks) @0690b048
...
;; Function ClockMonitorEmpty (ClockMonitorEmpty, funcdef_no=0, decl_uid=6067, cgraph_uid=1, symbol_order=1)
...
;; Function ClockMonitorEmpty_Disable (ClockMonitorEmpty_Disable, funcdef_no=1, decl_uid=6069, cgraph_uid=2, symbol_order=2)
...
;; Function ClockMonitorEmpty_GetStatus (ClockMonitorEmpty_GetStatus, funcdef_no=3, decl_uid=6073, cgraph_uid=4, symbol_order=4)
...
;; Function ClockMonitorEmpty_ClearStatus (ClockMonitorEmpty_ClearStatus, funcdef_no=5, decl_uid=6071, cgraph_uid=3, symbol_order=3)
