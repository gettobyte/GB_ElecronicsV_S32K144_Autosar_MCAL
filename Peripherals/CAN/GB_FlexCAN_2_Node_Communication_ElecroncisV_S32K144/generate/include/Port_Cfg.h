...
#if (PORT_VENDOR_ID_CFG_H != PORT_VENDOR_ID_BOARD_InitPeripherals_PBCFG_H)
...
#if ((PORT_AR_RELEASE_MAJOR_VERSION_CFG_H != PORT_AR_RELEASE_MAJOR_VERSION_BOARD_InitPeripherals_PBCFG_H) ||   \
     (PORT_AR_RELEASE_MINOR_VERSION_CFG_H != PORT_AR_RELEASE_MINOR_VERSION_BOARD_InitPeripherals_PBCFG_H) ||   \
     (PORT_AR_RELEASE_REVISION_VERSION_CFG_H != PORT_AR_RELEASE_REVISION_VERSION_BOARD_InitPeripherals_PBCFG_H) \
    )
...
#if ((PORT_SW_MAJOR_VERSION_CFG_H != PORT_SW_MAJOR_VERSION_BOARD_InitPeripherals_PBCFG_H) || \
     (PORT_SW_MINOR_VERSION_CFG_H != PORT_SW_MINOR_VERSION_BOARD_InitPeripherals_PBCFG_H) || \
     (PORT_SW_PATCH_VERSION_CFG_H != PORT_SW_PATCH_VERSION_BOARD_InitPeripherals_PBCFG_H)     \
    )
...
#define PortConfigSet_RGB_Port_Container_Red_Port_Pin 2
#define PortConfigSet_RGB_Port_Container_Green_Port_Pin 3
#define PortConfigSet_RGB_Port_Container_Blue_Port_PIN 4
#define PortConfigSet_Switch_PortContainer_PortPin_0 5
#define PortConfigSet_Switch_PortContainer_PortPin_1 6
#define PortConfigSet_ST7789_Pins_PortPin_0 7
#define PortConfigSet_ST7789_Pins_PortPin_1 8
#define PortConfigSet_ST7789_Pins_PortPin_2 9
#define PortConfigSet_ST7789_Pins_PortPin_3 10
#define PortConfigSet_ST7789_Pins_PortPin_4 11
