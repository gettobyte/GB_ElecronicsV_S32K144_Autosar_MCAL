...
==================================================================================================*/
#define TRGMUX_IP_TYPES_VENDOR_ID_H                    43
#define TRGMUX_IP_TYPES_MODULE_ID_H                    255
#define TRGMUX_IP_TYPES_AR_RELEASE_MAJOR_VERSION_H     4
#define TRGMUX_IP_TYPES_AR_RELEASE_MINOR_VERSION_H     4
#define TRGMUX_IP_TYPES_AR_RELEASE_REVISION_VERSION_H  0
#define TRGMUX_IP_TYPES_SW_MAJOR_VERSION_H             1
#define TRGMUX_IP_TYPES_SW_MINOR_VERSION_H             0
#define TRGMUX_IP_TYPES_SW_PATCH_VERSION_H             0
...
#if ((TRGMUX_IP_TYPES_AR_RELEASE_MAJOR_VERSION_H != STD_AR_RELEASE_MAJOR_VERSION) || \
     (TRGMUX_IP_TYPES_AR_RELEASE_MINOR_VERSION_H != STD_AR_RELEASE_MINOR_VERSION))
...
#if ((TRGMUX_IP_TYPES_AR_RELEASE_MAJOR_VERSION_H != MCAL_AR_RELEASE_MAJOR_VERSION) || \
     (TRGMUX_IP_TYPES_AR_RELEASE_MINOR_VERSION_H != MCAL_AR_RELEASE_MINOR_VERSION))
...
#if (TRGMUX_IP_TYPES_VENDOR_ID_H != TRGMUX_IP_CFG_DEFINES_VENDOR_ID_H)
...
#if ((TRGMUX_IP_TYPES_AR_RELEASE_MAJOR_VERSION_H != TRGMUX_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION_H) || \
     (TRGMUX_IP_TYPES_AR_RELEASE_MINOR_VERSION_H != TRGMUX_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION_H) || \
     (TRGMUX_IP_TYPES_AR_RELEASE_REVISION_VERSION_H != TRGMUX_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION_H) \
    )
...
#if ((TRGMUX_IP_TYPES_SW_MAJOR_VERSION_H != TRGMUX_IP_CFG_DEFINES_SW_MAJOR_VERSION_H) || \
     (TRGMUX_IP_TYPES_SW_MINOR_VERSION_H != TRGMUX_IP_CFG_DEFINES_SW_MINOR_VERSION_H) || \
     (TRGMUX_IP_TYPES_SW_PATCH_VERSION_H != TRGMUX_IP_CFG_DEFINES_SW_PATCH_VERSION_H) \
    )
...
#if (TRGMUX_IP_TYPES_VENDOR_ID_H != TRGMUX_IP_CFG_DEVICEREGISTERS_VENDOR_ID_H)
...
#if ((TRGMUX_IP_TYPES_AR_RELEASE_MAJOR_VERSION_H != TRGMUX_IP_CFG_DEVICEREGISTERS_AR_RELEASE_MAJOR_VERSION_H) || \
     (TRGMUX_IP_TYPES_AR_RELEASE_MINOR_VERSION_H != TRGMUX_IP_CFG_DEVICEREGISTERS_AR_RELEASE_MINOR_VERSION_H) || \
     (TRGMUX_IP_TYPES_AR_RELEASE_REVISION_VERSION_H != TRGMUX_IP_CFG_DEVICEREGISTERS_AR_RELEASE_REVISION_VERSION_H) \
    )
...
#if ((TRGMUX_IP_TYPES_SW_MAJOR_VERSION_H != TRGMUX_IP_CFG_DEVICEREGISTERS_SW_MAJOR_VERSION_H) || \
     (TRGMUX_IP_TYPES_SW_MINOR_VERSION_H != TRGMUX_IP_CFG_DEVICEREGISTERS_SW_MINOR_VERSION_H) || \
     (TRGMUX_IP_TYPES_SW_PATCH_VERSION_H != TRGMUX_IP_CFG_DEVICEREGISTERS_SW_PATCH_VERSION_H) \
    )
