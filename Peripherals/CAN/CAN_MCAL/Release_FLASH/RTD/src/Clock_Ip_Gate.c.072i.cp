...
ClockSetSimTraceEnable_TrustedCall.isra.0/27 (ClockSetSimTraceEnable_TrustedCall.isra.0) @06aaa700
...
ClockSetSimLPO1KEnable_TrustedCall.isra.0/22 (ClockSetSimLPO1KEnable_TrustedCall.isra.0) @069ee1c0
  ...
  Calls: 
clockFeatures/21 (clockFeatures) @069d11b0
  Type: variable
...
ClockUpdateSimTraceEnable/20 (ClockUpdateSimTraceEnable) @05de2540
  Type: function definition analyzed
...
ClockSetSimTraceEnable/19 (ClockSetSimTraceEnable) @05de22a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimGate/17 (ClockUpdateSimGate) @05dde620
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimGate/16 (ClockSetSimGate) @05ddee00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: ClockSetSimGate_TrustedCall/15 (1073741824 (estimated locally),1.00 per call) 
ClockSetSimGate_TrustedCall/15 (ClockSetSimGate_TrustedCall) @05ddeb60
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  ...
  Calls: 
ClockUpdatePccCgcEnable/14 (ClockUpdatePccCgcEnable) @05dde7e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetPccCgcEnable/13 (ClockSetPccCgcEnable) @05dde540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: ClockSetPccCgcEnable_TrustedCall/12 (1073741824 (estimated locally),1.00 per call) 
ClockSetPccCgcEnable_TrustedCall/12 (ClockSetPccCgcEnable_TrustedCall) @05dde2a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: clockFeatures/21 (read)
  Referring: 
  ...
  Calls: 
ClockUpdateSimClkoutEnable/11 (ClockUpdateSimClkoutEnable) @05dde000
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimClkoutEnable/10 (ClockSetSimClkoutEnable) @05cdc8c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimLPO32KEnable/8 (ClockUpdateSimLPO32KEnable) @05cdcd20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimLPO32KEnable/7 (ClockSetSimLPO32KEnable) @05cdca80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimLPO1KEnable/5 (ClockUpdateSimLPO1KEnable) @05cdc540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimLPO1KEnable/4 (ClockSetSimLPO1KEnable) @05cdc2a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateGateEmpty/2 (ClockUpdateGateEmpty) @05cd9ee0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
ClockSetGateEmpty/1 (ClockSetGateEmpty) @05cd9c40
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
gateCallbacks/0 (gateCallbacks) @05cd75e8
