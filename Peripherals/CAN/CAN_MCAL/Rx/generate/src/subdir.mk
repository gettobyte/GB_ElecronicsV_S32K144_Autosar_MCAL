...
C_SRCS += \
../generate/src/Can_BOARD_InitPeripherals_PBcfg.c \
...
C_DEPS += \
./generate/src/Can_BOARD_InitPeripherals_PBcfg.d \
./generate/src/Can_Ipw_BOARD_InitPeripherals_PBcfg.d \
...
generate/src/%.o: ../generate/src/%.c
	...
	arm-none-eabi-gcc "@generate/src/Can_BOARD_InitPeripherals_PBcfg.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
