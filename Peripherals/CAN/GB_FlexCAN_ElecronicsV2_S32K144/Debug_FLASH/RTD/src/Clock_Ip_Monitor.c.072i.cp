...
ClockMonitorEmpty_GetStatus/4 (ClockMonitorEmpty_GetStatus) @0696f460
  ...
  Called by: 
  Calls: 
ClockMonitorEmpty_ClearStatus/3 (ClockMonitorEmpty_ClearStatus) @0696f1c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockMonitorEmpty_Disable/2 (ClockMonitorEmpty_Disable) @068acee0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Calls: 
ClockMonitorEmpty/1 (ClockMonitorEmpty) @068ace00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
cmuCallbacks/0 (cmuCallbacks) @0696e000
