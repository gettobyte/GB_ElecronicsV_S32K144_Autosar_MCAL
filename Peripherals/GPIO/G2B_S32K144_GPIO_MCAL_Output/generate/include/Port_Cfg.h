...
*
*/
#define PortConfigSet_PortContainer_0_Red_LED 0
#define PortConfigSet_PortContainer_0_Green_LED 1
#define PortConfigSet_PortContainer_0_Blue_LED 2
#define PortConfigSet_PortContainer_0_SW_1 3
#define PortConfigSet_PortContainer_0_SW_2 4
