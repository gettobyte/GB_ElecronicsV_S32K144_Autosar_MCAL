...
/**
* @brief          Symbolic name for the port RGB_Port.
*/
#define DioConf_DioPort_RGB_Port  ((uint8)0x03U)
/**
...
/**
* @brief          Symbolic name for the channel Switch1.
*
*/
#define DioConf_DioChannel_Switch1  ((uint16)0x004cU)
/**
* @brief          Symbolic name for the channel Switch2.
*
*/
#define DioConf_DioChannel_Switch2  ((uint16)0x004dU)
