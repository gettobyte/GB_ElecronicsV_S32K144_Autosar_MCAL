...
ClockMonitorEmpty_GetStatus/4 (ClockMonitorEmpty_GetStatus) @068c1c40
  ...
  Called by: 
  Calls: 
ClockMonitorEmpty_ClearStatus/3 (ClockMonitorEmpty_ClearStatus) @068c19a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockMonitorEmpty_Disable/2 (ClockMonitorEmpty_Disable) @068c1700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Calls: 
ClockMonitorEmpty/1 (ClockMonitorEmpty) @068c1460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
cmuCallbacks/0 (cmuCallbacks) @069be000
