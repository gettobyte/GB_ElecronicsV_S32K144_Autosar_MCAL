...
/**
* @brief          Symbolic name for the channel DioChannel_15.
*
*/
#define DioConf_DioChannel_DioChannel_15  ((uint16)0x006fU)
/**
* @brief          Symbolic name for the channel DioChannel_16.
*
*/
#define DioConf_DioChannel_DioChannel_16  ((uint16)0x0070U)
