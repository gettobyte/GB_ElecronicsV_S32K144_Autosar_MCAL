...
/**
* @brief          PDB Ip Config for Hardware Unit ADC0 for configuration variant BOARD_INITPERIPHERALS.
*/
extern const Pdb_Adc_Ip_ConfigType PdbAdcIpConfig_0_BOARD_INITPERIPHERALS;
