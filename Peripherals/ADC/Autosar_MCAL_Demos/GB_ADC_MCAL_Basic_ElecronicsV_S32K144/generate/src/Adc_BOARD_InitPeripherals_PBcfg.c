...
*/
static Adc_ValueGroupType * Adc_aResultsBufferPtr[7];
...
*
*/
static const Adc_ChannelType Adc_Group1_Assignment_0_BOARD_INITPERIPHERALS[ADC_CFGSET_BOARD_INITPERIPHERALS_GROUP_1_CHANNELS] =
{
    0U,
    1U
};
...
*
*/
static const Adc_ChannelType Adc_Group4_Assignment_0_BOARD_INITPERIPHERALS[ADC_CFGSET_BOARD_INITPERIPHERALS_GROUP_4_CHANNELS] =
{
    0U,
    1U
};
...
*
*/
static const Adc_ChannelType Adc_Group5_Assignment_0_BOARD_INITPERIPHERALS[ADC_CFGSET_BOARD_INITPERIPHERALS_GROUP_5_CHANNELS] =
{
    0U,
    1U
};
...
*
*/
static const Adc_ChannelType Adc_Group6_Assignment_0_BOARD_INITPERIPHERALS[ADC_CFGSET_BOARD_INITPERIPHERALS_GROUP_6_CHANNELS] =
{
    2U
};
...
static const Adc_GroupConfigurationType Adc_GroupsCfg_BOARD_INITPERIPHERALS[] =
{
    ...
    /**< @brief Group1 -- Logical Unit Id 0 -- Hardware Unit ADC0 */
    {
...
#endif /* (ADC_ENABLE_GROUP_STREAMING_RESULTS_REORDER == STD_ON) */
        /**< @brief Channels assigned to the group*/
        Adc_Group1_Assignment_0_BOARD_INITPERIPHERALS, /* pAssignment */
        /**< @brief Number of channels in the group*/
        (Adc_ChannelIndexType)ADC_CFGSET_BOARD_INITPERIPHERALS_GROUP_1_CHANNELS, /* AssignedChannelCount */
        /**< @brief Last Channel configured */
        (Adc_ChannelType)(ADC_ID_CHANNEL_U8(12)), /* LastCh */
        /**< @brief First Channel configured */
        (Adc_ChannelType)(ADC_ID_CHANNEL_U8(1)), /* FirstCh */
        ...
        (boolean)FALSE, /* bAdcGroupLimitcheck */
#endif /* (STD_ON == ADC_ENABLE_LIMIT_CHECK) */
        &AdcIpwGroupConfig_1_BOARD_INITPERIPHERALS /* pAdcIpwGroupConfig */
    },
...
#endif /* (ADC_ENABLE_GROUP_STREAMING_RESULTS_REORDER == STD_ON) */
        /**< @brief Channels assigned to the group*/
        Adc_Group2_Assignment_0_BOARD_INITPERIPHERALS, /* pAssignment */
        /**< @brief Number of channels in the group*/
        (Adc_ChannelIndexType)ADC_CFGSET_BOARD_INITPERIPHERALS_GROUP_2_CHANNELS, /* AssignedChannelCount */
        /**< @brief Last Channel configured */
        (Adc_ChannelType)(ADC_ID_CHANNEL_U8(12)), /* LastCh */
        /**< @brief First Channel configured */
        (Adc_ChannelType)(ADC_ID_CHANNEL_U8(1)), /* FirstCh */
    ...
    /**< @brief Group4 -- Logical Unit Id 0 -- Hardware Unit ADC0 */
    {
...
#endif /* (ADC_ENABLE_GROUP_STREAMING_RESULTS_REORDER == STD_ON) */
        /**< @brief Channels assigned to the group*/
        Adc_Group4_Assignment_0_BOARD_INITPERIPHERALS, /* pAssignment */
        /**< @brief Number of channels in the group*/
        (Adc_ChannelIndexType)ADC_CFGSET_BOARD_INITPERIPHERALS_GROUP_4_CHANNELS, /* AssignedChannelCount */
        /**< @brief Last Channel configured */
        (Adc_ChannelType)(ADC_ID_CHANNEL_U8(12)), /* LastCh */
        /**< @brief First Channel configured */
        (Adc_ChannelType)(ADC_ID_CHANNEL_U8(1)), /* FirstCh */
        ...
        (boolean)FALSE, /* bAdcGroupLimitcheck */
#endif /* (STD_ON == ADC_ENABLE_LIMIT_CHECK) */
        &AdcIpwGroupConfig_4_BOARD_INITPERIPHERALS /* pAdcIpwGroupConfig */
    },
    /**< @brief Group5 -- Logical Unit Id 0 -- Hardware Unit ADC0 */
    {
        ...
        (Adc_HwUnitType)0, /* AdcLogicalUnitId */
        /**< @brief Access mode */
        ADC_ACCESS_MODE_STREAMING, /* eAccessMode */
        /**< @brief Conversion mode */
        ADC_CONV_MODE_ONESHOT, /* eMode */
        /**< @brief Conversion type */
        ADC_CONV_TYPE_NORMAL, /* eType */
...
#endif /* (ADC_ENABLE_CH_DISABLE_CH_NONAUTO_API == STD_ON) */
        /**< @brief Number of streaming samples */
        (Adc_StreamNumSampleType)ADC_STREAMING_NUM_SAMPLES(4), /* NumSamples */
#if (ADC_ENABLE_GROUP_STREAMING_RESULTS_REORDER == STD_ON)
        /**< @brief Arrange the adc results as multiple sets of group result buffer */
        (boolean)FALSE, /* bStreamResultGroupMultiSets */
#endif /* (ADC_ENABLE_GROUP_STREAMING_RESULTS_REORDER == STD_ON) */
        /**< @brief Channels assigned to the group*/
        Adc_Group5_Assignment_0_BOARD_INITPERIPHERALS, /* pAssignment */
        /**< @brief Number of channels in the group*/
        (Adc_ChannelIndexType)ADC_CFGSET_BOARD_INITPERIPHERALS_GROUP_5_CHANNELS, /* AssignedChannelCount */
        /**< @brief Last Channel configured */
        (Adc_ChannelType)(ADC_ID_CHANNEL_U8(12)), /* LastCh */
        /**< @brief First Channel configured */
        (Adc_ChannelType)(ADC_ID_CHANNEL_U8(1)), /* FirstCh */
        ...
        (boolean)FALSE, /* bAdcGroupLimitcheck */
#endif /* (STD_ON == ADC_ENABLE_LIMIT_CHECK) */
        &AdcIpwGroupConfig_5_BOARD_INITPERIPHERALS /* pAdcIpwGroupConfig */
    },
    /**< @brief Group6 -- Logical Unit Id 0 -- Hardware Unit ADC0 */
    {
...
#endif /* (ADC_ENABLE_GROUP_STREAMING_RESULTS_REORDER == STD_ON) */
        /**< @brief Channels assigned to the group*/
        Adc_Group6_Assignment_0_BOARD_INITPERIPHERALS, /* pAssignment */
        /**< @brief Number of channels in the group*/
        (Adc_ChannelIndexType)ADC_CFGSET_BOARD_INITPERIPHERALS_GROUP_6_CHANNELS, /* AssignedChannelCount */
        /**< @brief Last Channel configured */
        (Adc_ChannelType)(ADC_ID_CHANNEL_U8(27)), /* LastCh */
        /**< @brief First Channel configured */
        ...
        (boolean)FALSE, /* bAdcGroupLimitcheck */
#endif /* (STD_ON == ADC_ENABLE_LIMIT_CHECK) */
        &AdcIpwGroupConfig_6_BOARD_INITPERIPHERALS /* pAdcIpwGroupConfig */
    }
};
