...
ClockMonitorEmpty_GetStatus/4 (ClockMonitorEmpty_GetStatus) @05d7da80
  ...
  Called by: 
  Calls: 
ClockMonitorEmpty_ClearStatus/3 (ClockMonitorEmpty_ClearStatus) @05d7d7e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockMonitorEmpty_Disable/2 (ClockMonitorEmpty_Disable) @05d7d540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Calls: 
ClockMonitorEmpty/1 (ClockMonitorEmpty) @05d7d2a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
cmuCallbacks/0 (cmuCallbacks) @05cc3000
