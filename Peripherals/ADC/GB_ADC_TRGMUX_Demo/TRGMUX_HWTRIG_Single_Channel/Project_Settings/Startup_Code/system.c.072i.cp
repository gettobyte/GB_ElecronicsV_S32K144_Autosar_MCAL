...
sys_m4_cache_init.constprop.0/7 (sys_m4_cache_init.constprop) @0600bee0
  ...
  Calls: 
SystemInit/6 (SystemInit) @06018000
  Type: function definition analyzed
...
Sys_GetCoreID/4 (Sys_GetCoreID) @0600b9a0
  Type: function definition analyzed
  ...
  Called by: 
  Calls: 
default_interrupt_routine/3 (default_interrupt_routine) @0600be00
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
startup_go_to_user_mode/2 (startup_go_to_user_mode) @0600bb60
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
sys_m4_cache_init/1 (sys_m4_cache_init) @0600b7e0
  Type: function
  ...
  Called by: 
  Calls: 
RESET_CATCH_CORE/0 (RESET_CATCH_CORE) @06013a68
