...
undefined_handler/4 (undefined_handler) @0607c380
  Type: function
  ...
  Called by: 
  Calls: 
intRouteConfig/3 (intRouteConfig) @0607bc18
...
aIrqRouteConfig/2 (aIrqRouteConfig) @0607bbd0
  Type: variable definition analyzed
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
IntCtrlConfig_0/1 (IntCtrlConfig_0) @0607baf8
  Type: variable definition analyzed
  Visibility: externally_visible public
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
aIrqConfiguration1/0 (aIrqConfiguration1) @0607bab0
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
