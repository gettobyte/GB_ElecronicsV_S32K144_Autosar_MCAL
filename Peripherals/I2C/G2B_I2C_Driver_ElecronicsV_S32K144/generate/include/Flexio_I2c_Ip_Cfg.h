...
==================================================================================================*/
    ...
    #if ( (FLEXIO_I2C_IP_CFG_AR_RELEASE_MAJOR_VERSION != MCAL_AR_RELEASE_MAJOR_VERSION) || \
          (FLEXIO_I2C_IP_CFG_AR_RELEASE_MINOR_VERSION != MCAL_AR_RELEASE_MINOR_VERSION)    \
        )
...
*/
#define FLEXIO_I2C_IP_ENABLE_USER_MODE_SUPPORT    (STD_OFF)
