...
* Violates MISRA 2012 Advisory Rule 19.1, #include statements in a file should only be preceded
...
* Violates MISRA 2012 Required Rule 19.15, Precautions shall be taken in order to prevent the contents
...
* Violates MISRA 2012 Required Rule 1.4, The compiler/linker shall be checked to ensure
...
* Violates MISRA 2012 Required Rule 8.10, Not required from Autosar specification.
*
* @section CDD_I2c_c_REF_5
* Violates MISRA 2012 Required Rule 8.7, Objects shall be defined at block scope if they are only accessed
