...
ClockSetSimTraceEnable_TrustedCall.isra.0/27 (ClockSetSimTraceEnable_TrustedCall.isra.0) @077b6c40
  ...
  Calls: 
ClockSetSimClkoutEnable_TrustedCall.isra.0/24 (ClockSetSimClkoutEnable_TrustedCall.isra.0) @077b6380
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
ClockSetSimLPO32KEnable_TrustedCall.isra.0/23 (ClockSetSimLPO32KEnable_TrustedCall.isra.0) @076f3e00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
ClockSetSimLPO1KEnable_TrustedCall.isra.0/22 (ClockSetSimLPO1KEnable_TrustedCall.isra.0) @076f3620
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
  References: 
  Referring: 
  ...
  Calls: 
clockFeatures/21 (clockFeatures) @076e11b0
  Type: variable
...
ClockUpdateSimTraceEnable/20 (ClockUpdateSimTraceEnable) @06b34c40
  Type: function definition analyzed
...
ClockSetSimTraceEnable/19 (ClockSetSimTraceEnable) @06b349a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimGate/17 (ClockUpdateSimGate) @06b34460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimGate/16 (ClockSetSimGate) @06b341c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: ClockSetSimGate_TrustedCall/15 (1073741824 (estimated locally),1.00 per call) 
ClockSetSimGate_TrustedCall/15 (ClockSetSimGate_TrustedCall) @06b2ed20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  ...
  Calls: 
ClockUpdatePccCgcEnable/14 (ClockUpdatePccCgcEnable) @06b2eee0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetPccCgcEnable/13 (ClockSetPccCgcEnable) @06b2ec40
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: ClockSetPccCgcEnable_TrustedCall/12 (1073741824 (estimated locally),1.00 per call) 
ClockSetPccCgcEnable_TrustedCall/12 (ClockSetPccCgcEnable_TrustedCall) @06b2e9a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: clockFeatures/21 (read)
  Referring: 
  ...
  Calls: 
ClockUpdateSimClkoutEnable/11 (ClockUpdateSimClkoutEnable) @06b2e700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimClkoutEnable/10 (ClockSetSimClkoutEnable) @06b2e460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimLPO32KEnable/8 (ClockUpdateSimLPO32KEnable) @069eda80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimLPO32KEnable/7 (ClockSetSimLPO32KEnable) @069ed2a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateSimLPO1KEnable/5 (ClockUpdateSimLPO1KEnable) @069edc40
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockSetSimLPO1KEnable/4 (ClockSetSimLPO1KEnable) @069ed9a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockUpdateGateEmpty/2 (ClockUpdateGateEmpty) @069ed460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
ClockSetGateEmpty/1 (ClockSetGateEmpty) @069ed1c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
gateCallbacks/0 (gateCallbacks) @069ea5e8
