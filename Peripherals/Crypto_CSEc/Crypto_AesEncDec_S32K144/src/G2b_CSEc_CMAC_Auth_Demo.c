...
int main(void)
{
    ...
    ST7789_SetAddressWindow(ST7789_XStart,ST7789_YStart, ST7789_XEnd, ST7789_YEnd);
    ST7789_WriteString(0, 80, "CMAC Crypto Cipher Operation", Font_11x18, ST77XX_NEON_GREEN, ST77XX_BLACK);

    ST7789_WriteString(00, 100, "Demonstrating  Embedded Cryptography DiY Project for CMAC Cipher", Font_11x18,ST77XX_NEON_GREEN, ST77XX_BLACK);
