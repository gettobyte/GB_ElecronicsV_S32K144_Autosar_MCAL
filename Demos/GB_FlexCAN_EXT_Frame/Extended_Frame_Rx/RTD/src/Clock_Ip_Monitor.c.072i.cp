...
ClockMonitorEmpty_GetStatus/4 (ClockMonitorEmpty_GetStatus) @06a9a460
  ...
  Called by: 
  Calls: 
ClockMonitorEmpty_ClearStatus/3 (ClockMonitorEmpty_ClearStatus) @06a9a1c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ClockMonitorEmpty_Disable/2 (ClockMonitorEmpty_Disable) @069d9ee0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Calls: 
ClockMonitorEmpty/1 (ClockMonitorEmpty) @069d9e00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
cmuCallbacks/0 (cmuCallbacks) @069e1000
