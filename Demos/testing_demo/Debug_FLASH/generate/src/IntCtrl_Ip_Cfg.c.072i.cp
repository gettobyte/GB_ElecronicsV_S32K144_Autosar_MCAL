...
undefined_handler/4 (undefined_handler) @06cabd20
  Type: function
  ...
  Called by: 
  Calls: 
intRouteConfig/3 (intRouteConfig) @06caac18
...
aIrqRouteConfig/2 (aIrqRouteConfig) @06caabd0
  Type: variable definition analyzed
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
IntCtrlConfig_0/1 (IntCtrlConfig_0) @06caaaf8
  Type: variable definition analyzed
  Visibility: externally_visible public
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
aIrqConfiguration1/0 (aIrqConfiguration1) @06caaab0
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
