...
#define POWER_IP_EMPTY_RESET_REASON    ((uint32)33U)
/**
...
static Power_Ip_ResetType Power_Ip_ConvertIntergeToResetType(uint32 ResetReasonIndex)
{
    ...
    /* If the value of macro reset reason is not continuous, POWER_IP_EMPTY_RESET_REASON is used to fill missing index */
    ...
    if ( (ResetReasonArray[ResetReasonIndex] <= MCU_RESET_UNDEFINED) && ((uint32)ResetReasonArray[ResetReasonIndex] != POWER_IP_EMPTY_RESET_REASON) )
    {
